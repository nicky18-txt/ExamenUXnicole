(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomParserAdapterOpenapiYaml30 = {}, global.fs, global.path));
   ...
   * @public
   */
  class Callback extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Discriminator extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Encoding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Header extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'header';
    }
   ...
   * @public
   */
  class Link extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'link';
    }
   ...
   * @public
   */
  class MediaType extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Openapi extends minimExports.StringElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class RequestBody extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  const detectionRegExp = new RegExp(`(?<YAML>^(["']?)openapi\\2\\s*:\\s*(["']?)(?<version_yaml>3\\.0\\.(?:[1-9]\\d*|0))\\3(?:\\s+|$))|(?<JSON>"openapi"\\s*:\\s*"(?<version_json>3\\.0\\.(?:[1-9]\\d*|0))")`, "m");
  ...
  const parse = (_0, ..._1) => __async(null, [_0, ..._1], function* (source, options = {}) {
    ...
    if (isNotUndefined(result)) {
      const openApiElement = OpenApi3_0.refract(result, refractorOpts);
