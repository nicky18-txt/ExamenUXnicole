...
export declare class Mqtt5ServerBindingElement extends ObjectElement {
    ...
    set sessionExpiryInterval(sessionExpiryInterval: NumberElement | SchemaElement | ReferenceElement | undefined);
    get bindingVersion(): StringElement | undefined;
    set bindingVersion(bindingVersion: StringElement | undefined);
}
                ...
                bindings: {
                    ...
                    mqtt5: {
                        ServerBinding: {
                            ...
                            fixedFields: {
                                sessionExpiryInterval: typeof SchemaOrReferenceVisitor;
                                bindingVersion: {
                                    $ref: string;
                                };
                            };
