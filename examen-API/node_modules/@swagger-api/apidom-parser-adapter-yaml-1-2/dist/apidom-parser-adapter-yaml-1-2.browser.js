(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomParserAdapterYaml12 = {}, global.fs, global.path));
   ...
   * @public
   */
  let ParseResult$1 = class ParseResult extends Node {
   ...
   * @public
   */
  const getNodeType$2 = node => node === null || node === void 0 ? void 0 : node.type;

  /**
   * @public
   */
  const isNode$3 = node => typeof getNodeType$2(node) === 'string';
   ...
   */
  // @ts-ignore
  visit$1[Symbol.for('nodejs.util.promisify.custom')] = async (
  // @ts-ignore
  root,
  // @ts-ignore
  visitor, {
  ...
  // isNode :: Node -> Boolean
  const isNode$2 = pipe(getNodeType$1, isString);
  ...
  minimExports.ObjectElement.refract = createRefractor(minimExports.ObjectElement);
  minimExports.ArrayElement.refract = createRefractor(minimExports.ArrayElement);
  minimExports.StringElement.refract = createRefractor(minimExports.StringElement);
  minimExports.BooleanElement.refract = createRefractor(minimExports.BooleanElement);
  minimExports.NullElement.refract = createRefractor(minimExports.NullElement);
  minimExports.NumberElement.refract = createRefractor(minimExports.NumberElement);
  minimExports.LinkElement.refract = createRefractor(minimExports.LinkElement);
  minimExports.RefElement.refract = createRefractor(minimExports.RefElement);
  Annotation.refract = createRefractor(Annotation);
  Comment.refract = createRefractor(Comment);
  ParseResult.refract = createRefractor(ParseResult);
  ...
  class TreeCursorSyntaxNode {
    constructor(cursor) {
      ...
      __publicField$3(this, "startPositionRow");
      __publicField$3(this, "startPositionColumn");
      __publicField$3(this, "startIndex");
      __publicField$3(this, "endPositionRow");
      __publicField$3(this, "endPositionColumn");
      __publicField$3(this, "endIndex");
      __publicField$3(this, "text");
      __publicField$3(this, "isNamed");
      __publicField$3(this, "isMissing");
      __publicField$3(this, "fieldName");
      __publicField$3(this, "hasError", false);
      __publicField$3(this, "children", []);
      __publicField$3(this, "previousSibling");
  ...
  const _CstVisitor = class _CstVisitor {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    constructor(schema) {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      __publicField$2(this, "schema");
      __publicField$2(this, "referenceManager");
      __publicField$2(this, "stream", {
        ...
        leave: (stream) => {
          return new ParseResult$1({ children: [stream] });
        }
      });
      __publicField$2(this, "yaml_directive", {
        enter: (node) => {
          var _a;
          const version = (_a = node == null ? void 0 : node.firstNamedChild) == null ? void 0 : _a.text;
      ...
      __publicField$2(this, "tag_directive", {
        enter: (node) => {
      ...
      __publicField$2(this, "reserved_directive", {
        enter: (node) => {
      ...
      __publicField$2(this, "block_node", {
        enter: (node) => {
          return node.children;
        }
      });
      __publicField$2(this, "flow_node", {
        enter: (node) => {
          const [kindCandidate] = node.children.slice(-1);
          if (_CstVisitor.isScalar(kindCandidate) || _CstVisitor.isMapping(kindCandidate) || _CstVisitor.isSequence(kindCandidate)) {
            return node.children;
          }
          const emptyScalarNode = new YamlScalar({
            content: "",
            anchor: _CstVisitor.kindNodeToYamlAnchor(kindCandidate),
            tag: _CstVisitor.kindNodeToYamlTag(kindCandidate),
      ...
      __publicField$2(this, "tag", {
        enter: () => {
          return null;
        }
      });
      __publicField$2(this, "anchor", {
        enter: () => {
          return null;
        }
      });
      __publicField$2(this, "block_mapping", {
        enter: (node) => {
          const tag = _CstVisitor.kindNodeToYamlTag(node);
          const anchor = _CstVisitor.kindNodeToYamlAnchor(node);
      ...
      __publicField$2(this, "block_mapping_pair", {
        enter: (node) => {
          const children = [...node.children];
          if (_CstVisitor.hasKeyValuePairEmptyKey(node)) {
            const keyNode = this.createKeyValuePairEmptyKey(node);
            children.unshift(keyNode);
          }
          if (_CstVisitor.hasKeyValuePairEmptyValue(node)) {
      ...
      __publicField$2(this, "flow_mapping", {
        enter: (node) => {
          const tag = _CstVisitor.kindNodeToYamlTag(node);
          const anchor = _CstVisitor.kindNodeToYamlAnchor(node);
          const mappingNode = new YamlMapping(
      ...
      __publicField$2(this, "flow_pair", {
        enter: (node) => {
          const children = [...node.children];
          if (_CstVisitor.hasKeyValuePairEmptyKey(node)) {
            const keyNode = this.createKeyValuePairEmptyKey(node);
      ...
      __publicField$2(this, "keyValuePair", {
        leave: (node) => {
          node.children = node.children.flat();
        }
      });
      __publicField$2(this, "block_sequence", {
        enter: (node) => {
          const tag = _CstVisitor.kindNodeToYamlTag(node);
          const anchor = _CstVisitor.kindNodeToYamlAnchor(node);
      ...
      __publicField$2(this, "block_sequence_item", {
        enter: (node) => {
      ...
      __publicField$2(this, "flow_sequence", {
        enter: (node) => {
          const tag = _CstVisitor.kindNodeToYamlTag(node);
          const anchor = _CstVisitor.kindNodeToYamlAnchor(node);
          const sequenceNode = new YamlSequence(
      ...
      __publicField$2(this, "sequence", {
        leave: (node) => {
          node.children = node.children.flat(Infinity);
        }
      });
      __publicField$2(this, "plain_scalar", {
        enter: (node) => {
          const tag = _CstVisitor.kindNodeToYamlTag(node);
          const anchor = _CstVisitor.kindNodeToYamlAnchor(node);
      ...
      __publicField$2(this, "single_quote_scalar", {
        enter: (node) => {
          const tag = _CstVisitor.kindNodeToYamlTag(node);
          const anchor = _CstVisitor.kindNodeToYamlAnchor(node);
          const scalarNode = new YamlScalar(
      ...
      __publicField$2(this, "double_quote_scalar", {
        enter: (node) => {
          const tag = _CstVisitor.kindNodeToYamlTag(node);
          const anchor = _CstVisitor.kindNodeToYamlAnchor(node);
          const scalarNode = new YamlScalar(
      ...
      __publicField$2(this, "block_scalar", {
        enter: (node) => {
          const tag = _CstVisitor.kindNodeToYamlTag(node);
          const anchor = _CstVisitor.kindNodeToYamlAnchor(node);
      ...
      __publicField$2(this, "comment", {
        enter: (node) => {
          return new YamlComment({ content: node.text });
        }
      });
      __publicField$2(this, "alias", {
        enter: (node) => {
    ...
    static kindNodeToYamlAnchor(node) {
      ...
      if (typeof anchorNode === "undefined") return void 0;
    ...
    static kindNodeToYamlTag(node) {
      ...
      return new YamlTag(assignSourceMap({ explicitName, kind }, tagNode));
    }
    // eslint-disable-next-line class-methods-use-this
    enter(node) {
    ...
    ERROR(node, key, parent, path) {
      ...
      if (path.length === 0) {
        return new ParseResult$1({ children: [errorNode] });
      }
      return errorNode;
    }
    registerAnchor(node) {
      if (node.anchor !== void 0) {
    ...
    createKeyValuePairEmptyKey(node) {
      ...
      const tagNode = children.find(_CstVisitor.isKind("tag"));
      const anchorNode = children.find(_CstVisitor.isKind("anchor"));
  ...
  __publicField$2(_CstVisitor, "isScalar", _CstVisitor.isKind("scalar"));
  __publicField$2(_CstVisitor, "isMapping", _CstVisitor.isKind("mapping"));
  __publicField$2(_CstVisitor, "isSequence", _CstVisitor.isKind("sequence"));
  let CstVisitor = _CstVisitor;
  ...
  class YamlAstVisitor {
    constructor() {
      __publicField$1(this, "sourceMap", false);
      __publicField$1(this, "annotations");
      __publicField$1(this, "namespace");
      __publicField$1(this, "processedDocumentCount", 0);
      __publicField$1(this, "stream", {
        leave: (node) => {
          const element = new ParseResult();
    ...
    error(node, key, parent, path) {
      ...
      this.maybeAddSourceMap(node, element);
      if (path.length === 0) {
        const parseResultElement = new ParseResult();
  ...
  const analyze = (cst, { sourceMap = false } = {}) => {
    ...
    const yamlAst = visit$1(rootNode, cstVisitor, {
      // @ts-ignore
      keyMap: keyMap$1,
    ...
    return visit$1(yamlAst.rootNode, astVisitor, {
      // @ts-ignore
      keyMap: keyMap,
  ...
  class YamlMediaTypes extends MediaTypes {
    latest() {
      return this[1];
    }
  }
  ...
  exports.lexicalAnalysis = analyze$1;
  exports.mediaTypes = mediaTypes;
  exports.namespace = namespace;
  exports.parse = parse;
  exports.syntacticAnalysis = analyze;
