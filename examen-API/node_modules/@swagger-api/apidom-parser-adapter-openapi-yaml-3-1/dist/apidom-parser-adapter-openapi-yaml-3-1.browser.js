(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomParserAdapterOpenapiYaml31 = {}, global.fs, global.path));
  ...
  /* eslint-disable class-methods-use-this */
  class GenericMapping extends Tag$2 {
  ...
  /* eslint-disable class-methods-use-this */
  class GenericSequence extends Tag$2 {
  ...
  class GenericString extends Tag$2 {
  ...
  /* eslint-disable class-methods-use-this */
  let Boolean$1 = class Boolean extends Tag$2 {
  ...
  /* eslint-disable class-methods-use-this */
  class FloatingPoint extends Tag$2 {
  ...
  // isNode :: Node -> Boolean
  const isNode$2 = pipe(getNodeType$3, isString);
  ...
  ParseResult$1.refract = createRefractor$6(ParseResult$1);
   ...
   * @public
   */
  let JSONSchemaVisitor$4 = class JSONSchemaVisitor extends Mixin(FixedFieldsVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
   ...
   * @public
   */
  let PropertiesVisitor$2 = class PropertiesVisitor extends Mixin(MapVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
   ...
   * @public
   */
  let AllOfVisitor$2 = class AllOfVisitor extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
   ...
   * @public
   */
  let AnyOfVisitor$2 = class AnyOfVisitor extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
   ...
   * @public
   */
  let OneOfVisitor$2 = class OneOfVisitor extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
   ...
   * @public
   */
  let LinkDescriptionVisitor$4 = class LinkDescriptionVisitor extends Mixin(FixedFieldsVisitor$1, FallbackVisitor$1) {
    constructor(options) {
      super(options);
    ...
    visitors: {
      ...
      document: {
        objects: {
          ...
          LinkDescription: {
            $visitor: LinkDescriptionVisitor$4,
            fixedFields: {
              href: {
                $ref: '#/visitors/value'
              },
  ...
  const refract$5 = (value, {
    ...
    plugins = [],
    specificationObj = specification$5
  } = {}) => {
   ...
   * @public
   */
  let EncodingVisitor$1 = class EncodingVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
   ...
   * @public
   */
  let SchemaVisitor$1 = class SchemaVisitor extends Mixin(AlternatingVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.alternator = [{
        predicate: isReferenceLikeElement,
   ...
   * @public
   */
  const JSONSchemaAllOfVisitor = specification$5.visitors.document.objects.JSONSchema.fixedFields.allOf;

  /**
   * @public
   */
  let AllOfVisitor$1 = class AllOfVisitor extends JSONSchemaAllOfVisitor {
    ArrayElement(arrayElement) {
   ...
   * @public
   */
  const JSONSchemaAnyOfVisitor = specification$5.visitors.document.objects.JSONSchema.fixedFields.anyOf;

  /**
   * @public
   */
  let AnyOfVisitor$1 = class AnyOfVisitor extends JSONSchemaAnyOfVisitor {
    ArrayElement(arrayElement) {
   ...
   * @public
   */
  const JSONSchemaOneOfVisitor = specification$5.visitors.document.objects.JSONSchema.fixedFields.oneOf;

  /**
   * @public
   */
  let OneOfVisitor$1 = class OneOfVisitor extends JSONSchemaOneOfVisitor {
    ArrayElement(arrayElement) {
   ...
   * @public
   */
  const JSONSchemaItemsVisitor = specification$5.visitors.document.objects.JSONSchema.fixedFields.items;
   ...
   * @public
   */
  const JSONSchemaPropertiesVisitor = specification$5.visitors.document.objects.JSONSchema.fixedFields.properties;

  /**
   * @public
   */
  let PropertiesVisitor$1 = class PropertiesVisitor extends JSONSchemaPropertiesVisitor {
    ObjectElement(objectElement) {
   ...
   * @public
   */
  const JSONSchemaTypeVisitor = specification$5.visitors.document.objects.JSONSchema.fixedFields.type;
   ...
   */
  // eslint-disable-next-line prefer-destructuring
  const JSONSchemaOrJSONReferenceVisitor = specification$5.visitors.JSONSchemaOrJSONReferenceVisitor;
   ...
   * @public
   */
  let ResponsesVisitor$1 = class ResponsesVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
   ...
   * @public
   */
  let RequestBodyVisitor$1 = class RequestBodyVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
  ...
  } = specification$5.visitors.document.objects.JSONSchema;
        ...
        objects: {
          ...
          Operation: {
            ...
            fixedFields: {
              ...
              requestBody: RequestBodyVisitor,
              responses: {
  ...
  const refract$4 = (value, {
    ...
    const element = minimExports.refract(value);
    const resolvedSpec = dereference(specification$4);
   ...
   * @public
   */
  class JsonSchemaDialect extends minimExports.StringElement {
   ...
   * @public
   */
  class $defsVisitor extends Mixin(MapVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ObjectElement();
   ...
   * @public
   */
  class AllOfVisitor extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
      this.element.classes.push('json-schema-allOf');
   ...
   * @public
   */
  class AnyOfVisitor extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
      this.element.classes.push('json-schema-anyOf');
   ...
   * @public
   */
  class OneOfVisitor extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
      this.element.classes.push('json-schema-oneOf');
   ...
   * @public
   */
  class DependentSchemasVisitor extends Mixin(MapVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ObjectElement();
   ...
   * @public
   */
  class PropertiesVisitor extends Mixin(MapVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ObjectElement();
      this.element.classes.push('json-schema-properties');
   ...
   * @public
   */
  class PatternPropertiesVisitor extends Mixin(MapVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ObjectElement();
      this.element.classes.push('json-schema-patternProperties');
   ...
   * @public
   */
  class PrefixItemsVisitor extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
  ...
  const detectionRegExp = new RegExp(`(?<YAML>^(["']?)openapi\\2\\s*:\\s*(["']?)(?<version_yaml>3\\.1\\.(?:[1-9]\\d*|0))\\3(?:\\s+|$))|(?<JSON>"openapi"\\s*:\\s*"(?<version_json>3\\.1\\.(?:[1-9]\\d*|0))")`, "m");
  ...
  const parse = (_0, ..._1) => __async(null, [_0, ..._1], function* (source, options = {}) {
    ...
    if (isNotUndefined(result)) {
      const openApiElement = OpenApi3_1.refract(result, refractorOpts);
