(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomParserAdapterApiDesignSystemsYaml = {}, global.fs, global.path));
  ...
  ParseResult$1.refract = createRefractor(ParseResult$1);
   ...
   * @public
   */
  class ApiDesignSystemsMediaTypes extends MediaTypes {
   ...
   * @public
   */
  class Main extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'main';
   ...
   * @public
   */
  class Principle extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Requirement extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class RequirementLevel extends minimExports.StringElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Scenario extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Standard extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class StandardIdentifier extends minimExports.ArrayElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  const apiDesignSystems = {
    namespace: options => {
      ...
      base.register('main', Main);
      base.register('principle', Principle);
      base.register('requirement', Requirement);
      base.register('requirementLevel', RequirementLevel);
      base.register('scenario', Scenario);
      base.register('standard', Standard);
      base.register('standardIdentifier', StandardIdentifier);
      return base;
    }
  };
  ...
  const detectionRegExp = new RegExp(`(?<YAML>^(["']?)version\\2\\s*:\\s*(["']?)(?<version_yaml>2021-05-07)\\3)|(?<JSON>"version"\\s*:\\s*"(?<version_json>2021-05-07)")`, "m");
  ...
  const parse = (_0, ..._1) => __async(null, [_0, ..._1], function* (source, options = {}) {
    ...
    if (isNotUndefined(result)) {
      const mainElement = Main.refract(result, refractorOpts);
      mainElement.classes.push("result");
      parseResultElement.replaceResult(mainElement);
    }
    return parseResultElement;
  });
  const namespace = createNamespace(apiDesignSystems);
