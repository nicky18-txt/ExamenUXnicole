(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomParserAdapterArazzoYaml1 = {}, global.fs, global.path));
  ...
  /* eslint-disable class-methods-use-this */
  let Boolean$1 = class Boolean extends Tag {
  ...
  const createRefractor$5 = Type => (value, options = {}) => refract$5(value, {
    ...options,
    Type
  });

  minimExports.ObjectElement.refract = createRefractor$5(minimExports.ObjectElement);
  minimExports.ArrayElement.refract = createRefractor$5(minimExports.ArrayElement);
  minimExports.StringElement.refract = createRefractor$5(minimExports.StringElement);
  minimExports.BooleanElement.refract = createRefractor$5(minimExports.BooleanElement);
  minimExports.NullElement.refract = createRefractor$5(minimExports.NullElement);
  minimExports.NumberElement.refract = createRefractor$5(minimExports.NumberElement);
  minimExports.LinkElement.refract = createRefractor$5(minimExports.LinkElement);
  minimExports.RefElement.refract = createRefractor$5(minimExports.RefElement);
  Annotation.refract = createRefractor$5(Annotation);
  Comment.refract = createRefractor$5(Comment);
  ParseResult$1.refract = createRefractor$5(ParseResult$1);
   ...
   * @public
   */
  class ArazzoMediaTypes extends MediaTypes {
   ...
   * @public
   */
  let JSONSchemaVisitor$4 = class JSONSchemaVisitor extends Mixin(FixedFieldsVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
   ...
   * @public
   */
  let ItemsVisitor$2 = class ItemsVisitor extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    ObjectElement(objectElement) {
   ...
   * @public
   */
  let PropertiesVisitor$1 = class PropertiesVisitor extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
   ...
   * @public
   */
  let PatternPropertiesVisitor$1 = class PatternPropertiesVisitor extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ObjectElement();
   ...
   * @public
   */
  let AllOfVisitor$1 = class AllOfVisitor extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
   ...
   * @public
   */
  let AnyOfVisitor$1 = class AnyOfVisitor extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
   ...
   * @public
   */
  let OneOfVisitor$1 = class OneOfVisitor extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
   ...
   * @public
   */
  let LinkDescriptionVisitor$4 = class LinkDescriptionVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
  ...
  JSONSchema$4.refract = createRefractor$4(['visitors', 'document', 'objects', 'JSONSchema', '$visitor']);
  JSONReference.refract = createRefractor$4(['visitors', 'document', 'objects', 'JSONReference', '$visitor']);
  Media.refract = createRefractor$4(['visitors', 'document', 'objects', 'Media', '$visitor']);
  LinkDescription$4.refract = createRefractor$4(['visitors', 'document', 'objects', 'LinkDescription', '$visitor']);
   ...
   * @public
   */
  class ArazzoSpecification1 extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class ArazzoSpec extends minimExports.StringElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class SourceDescription extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Workflow extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Step extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'step';
    }
   ...
   * @public
   */
  class SuccessAction extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class FailureAction extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Criterion extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  const arazzo1 = {
    namespace: options => {
      ...
      base.register('arazzoSpecification1', ArazzoSpecification1);
      base.register('arazzoSpec', ArazzoSpec);
      base.register('info', Info);
      base.register('sourceDescription', SourceDescription);
      base.register('workflow', Workflow);
      base.register('step', Step);
      base.register('parameter', Parameter);
      base.register('successAction', SuccessAction);
      base.register('failureAction', FailureAction);
      base.register('components', Components);
      base.register('criterion', Criterion);
  ...
  const detectionRegExp = new RegExp(`(?<YAML>^(["']?)arazzo\\2\\s*:\\s*(["']?)(?<version_yaml>1\\.(?:[1-9]\\d*|0)\\.(?:[1-9]\\d*|0))\\3(?:\\s+|$))|(?<JSON>"arazzo"\\s*:\\s*"(?<version_json>1\\.(?:[1-9]\\d*|0)\\.(?:[1-9]\\d*|0))")`, "m");
  ...
  const parse = (_0, ..._1) => __async(null, [_0, ..._1], function* (source, options = {}) {
    ...
    if (isNotUndefined(result)) {
      const arazzoSpecificationElement = ArazzoSpecification1.refract(result, refractorOpts);
      arazzoSpecificationElement.classes.push("result");
      parseResultElement.replaceResult(arazzoSpecificationElement);
    }
    return parseResultElement;
  });
  const namespace = createNamespace(arazzo1);
