(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomNsAsyncapi3 = {}));
  ...
  const createRefractor$4 = Type => (value, options = {}) => refract$4(value, {
    ...options,
    Type
  });

  minimExports.ObjectElement.refract = createRefractor$4(minimExports.ObjectElement);
  minimExports.ArrayElement.refract = createRefractor$4(minimExports.ArrayElement);
  minimExports.StringElement.refract = createRefractor$4(minimExports.StringElement);
  minimExports.BooleanElement.refract = createRefractor$4(minimExports.BooleanElement);
  minimExports.NullElement.refract = createRefractor$4(minimExports.NullElement);
  minimExports.NumberElement.refract = createRefractor$4(minimExports.NumberElement);
  minimExports.LinkElement.refract = createRefractor$4(minimExports.LinkElement);
  minimExports.RefElement.refract = createRefractor$4(minimExports.RefElement);
  Annotation.refract = createRefractor$4(Annotation);
  Comment.refract = createRefractor$4(Comment);
  ParseResult.refract = createRefractor$4(ParseResult);
  ...
  let AsyncAPIMediaTypes$1 = class AsyncAPIMediaTypes extends MediaTypes {
  ...
  const mediaTypes$1 = new AsyncAPIMediaTypes$1(
   ...
   * @public
   */
  class AsyncAPIMediaTypes extends MediaTypes {
    filterByFormat(format = 'generic') {
      const effectiveFormat = format === 'generic' ? 'asyncapi;version' : format;
      return this.filter(mediaType => mediaType.includes(effectiveFormat));
    }
   ...
   * @public
   */
  class AsyncApi2 extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let AsyncApiVersion$1 = class AsyncApiVersion extends minimExports.StringElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let ChannelBindings$1 = class ChannelBindings extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class ChannelItem extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Channels$1 = class Channels extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let CorrelationID$1 = class CorrelationID extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let DefaultContentType$1 = class DefaultContentType extends minimExports.StringElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Identifier$1 = class Identifier extends minimExports.StringElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Message$1 = class Message extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MessageBindings$1 = class MessageBindings extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MessageExample$1 = class MessageExample extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MessageTrait$1 = class MessageTrait extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let OperationBindings$1 = class OperationBindings extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let OperationTrait$1 = class OperationTrait extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Parameters$1 = class Parameters extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let JSONSchema$2 = class JSONSchema extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  let LinkDescription$2 = class LinkDescription extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  const jsonSchemaDraft4 = {
    namespace: options => {
      ...
      base.register('jSONSchemaDraft4', JSONSchema$2);
  ...
  const isJSONSchemaElement$2 = createPredicate(({
    ...
    return element => element instanceof JSONSchema$2 || hasBasicElementProps(element) && isElementType('JSONSchemaDraft4', element) && primitiveEq('object', element);
  });
   ...
   * @public
   */
  let JSONSchemaVisitor$2 = class JSONSchemaVisitor extends Mixin(FixedFieldsVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
    ...
    handleDialectIdentifier(objectElement) {
      ...
      } else if (isJSONSchemaElement$2(this.parent) && !isStringElement(objectElement.get('$schema'))) {
   ...
   * @public
   */
  let ItemsVisitor$2 = class ItemsVisitor extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    ObjectElement(objectElement) {
   ...
   * @public
   */
  let DependenciesVisitor$1 = class DependenciesVisitor extends Mixin(MapVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ObjectElement();
   ...
   * @public
   */
  class TypeVisitor extends FallbackVisitor$1 {
   ...
   * @public
   */
  let DefinitionsVisitor$1 = class DefinitionsVisitor extends Mixin(MapVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ObjectElement();
   ...
   * @public
   */
  class LinksVisitor extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
    constructor(options) {
      super(options);
      this.element = new minimExports.ArrayElement();
   ...
   * @public
   */
  let LinkDescriptionVisitor$2 = class LinkDescriptionVisitor extends Mixin(FixedFieldsVisitor$1, FallbackVisitor$1) {
    constructor(options) {
      super(options);
        ...
        objects: {
          JSONSchema: {
            ...
            fixedFields: {
              ...
              properties: PropertiesVisitor$1,
              additionalProperties: SchemaOrReferenceVisitor$1,
              patternProperties: PatternPropertiesVisitor$1,
              dependencies: DependenciesVisitor$1,
              // validation keywords for any instance type
              enum: EnumVisitor,
              type: TypeVisitor,
              allOf: AllOfVisitor$1,
              anyOf: AnyOfVisitor$1,
              oneOf: OneOfVisitor$1,
              not: SchemaOrReferenceVisitor$1,
              definitions: DefinitionsVisitor$1,
              // metadata keywords
              title: {
                $ref: '#/visitors/value'
              },
  ...
  JSONSchema$2.refract = createRefractor$3(['visitors', 'document', 'objects', 'JSONSchema', '$visitor']);
  JSONReference.refract = createRefractor$3(['visitors', 'document', 'objects', 'JSONReference', '$visitor']);
  Media.refract = createRefractor$3(['visitors', 'document', 'objects', 'Media', '$visitor']);
  LinkDescription$2.refract = createRefractor$3(['visitors', 'document', 'objects', 'LinkDescription', '$visitor']);
  ...
  const jsonSchemaDraft6 = {
    namespace: options => {
      ...
      base.register('jSONSchemaDraft6', JSONSchema$1);
      base.register('jSONReference', JSONReference);
      base.register('media', Media);
   ...
   * @public
   */
  let ItemsVisitor$1 = class ItemsVisitor extends ItemsVisitor$2 {
    BooleanElement(booleanElement) {
   ...
   * @public
   */
  let ExamplesVisitor$2 = class ExamplesVisitor extends FallbackVisitor$1 {
    ArrayElement(arrayElement) {
      const result = this.enter(arrayElement);
  ...
  const isJSONSchemaElement$1 = createPredicate(({
    ...
    return element => element instanceof JSONSchema$1 || hasBasicElementProps(element) && isElementType('JSONSchemaDraft6', element) && primitiveEq('object', element);
  });
  ...
  JSONSchema$1.refract = createRefractor$2(['visitors', 'document', 'objects', 'JSONSchema', '$visitor']);
  LinkDescription$1.refract = createRefractor$2(['visitors', 'document', 'objects', 'LinkDescription', '$visitor']);
  ...
  const jsonSchemaDraft7 = {
    namespace: options => {
      ...
      base.register('jSONSchemaDraft7', JSONSchema);
      base.register('jSONReference', JSONReference);
   ...
   * @public
   */
  class JSONSchemaVisitor extends JSONSchemaVisitor$1 {
    constructor(options) {
      super(options);
   ...
   * @public
   */
  class LinkDescriptionVisitor extends LinkDescriptionVisitor$1 {
    constructor(options) {
      super(options);
  ...
  const isJSONSchemaElement = createPredicate(({
    ...
    return element => element instanceof JSONSchema || hasBasicElementProps(element) && isElementType('JSONSchemaDraft7', element) && primitiveEq('object', element);
  });
  ...
  JSONSchema.refract = createRefractor$1(['visitors', 'document', 'objects', 'JSONSchema', '$visitor']);
  LinkDescription.refract = createRefractor$1(['visitors', 'document', 'objects', 'LinkDescription', '$visitor']);

  /**
   * @public
   */
  let Schema$1 = class Schema extends JSONSchema {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'schema';
   ...
   * @public
   */
  class SecurityRequirement extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let ServerBindings$1 = class ServerBindings extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Servers$1 = class Servers extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Tags$1 = class Tags extends minimExports.ArrayElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'tags';
    }
   ...
   * @public
   */
  let AmqpChannelBinding$1 = class AmqpChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let AmqpMessageBinding$1 = class AmqpMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let AmqpOperationBinding$1 = class AmqpOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let AmqpServerBinding$1 = class AmqpServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Amqp1ChannelBinding$1 = class Amqp1ChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Amqp1MessageBinding$1 = class Amqp1MessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Amqp1OperationBinding$1 = class Amqp1OperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Amqp1ServerBinding$1 = class Amqp1ServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let AnypointmqChannelBinding$1 = class AnypointmqChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let AnypointmqMessageBinding$1 = class AnypointmqMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let AnypointmqOperationBinding$1 = class AnypointmqOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let AnypointmqServerBinding$1 = class AnypointmqServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let GooglepubsubChannelBinding$1 = class GooglepubsubChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let GooglepubsubMessageBinding$1 = class GooglepubsubMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let GooglepubsubOperationBinding$1 = class GooglepubsubOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let GooglepubsubServerBinding$1 = class GooglepubsubServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let HttpChannelBinding$1 = class HttpChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let HttpMessageBinding$1 = class HttpMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let HttpOperationBinding$1 = class HttpOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let HttpServerBinding$1 = class HttpServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let IbmmqChannelBinding$1 = class IbmmqChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let IbmmqMessageBinding$1 = class IbmmqMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let IbmmqOperationBinding$1 = class IbmmqOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let IbmmqServerBinding$1 = class IbmmqServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let JmsChannelBinding$1 = class JmsChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let JmsMessageBinding$1 = class JmsMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let JmsOperationBinding$1 = class JmsOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let JmsServerBinding$1 = class JmsServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let KafkaChannelBinding$1 = class KafkaChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let KafkaMessageBinding$1 = class KafkaMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let KafkaOperationBinding$1 = class KafkaOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let KafkaServerBinding$1 = class KafkaServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MercureChannelBinding$1 = class MercureChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MercureMessageBinding$1 = class MercureMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MercureOperationBinding$1 = class MercureOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MercureServerBinding$1 = class MercureServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MqttChannelBinding$1 = class MqttChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MqttMessageBinding$1 = class MqttMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MqttOperationBinding$1 = class MqttOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let MqttServerBinding$1 = class MqttServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Mqtt5ChannelBinding$1 = class Mqtt5ChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Mqtt5MessageBinding$1 = class Mqtt5MessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Mqtt5OperationBinding$1 = class Mqtt5OperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let Mqtt5ServerBinding$1 = class Mqtt5ServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let NatsChannelBinding$1 = class NatsChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let NatsMessageBinding$1 = class NatsMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let NatsOperationBinding$1 = class NatsOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let NatsServerBinding$1 = class NatsServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let PulsarChannelBinding$1 = class PulsarChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let PulsarMessageBinding$1 = class PulsarMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let PulsarOperationBinding$1 = class PulsarOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let PulsarServerBinding$1 = class PulsarServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let RedisChannelBinding$1 = class RedisChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let RedisMessageBinding$1 = class RedisMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let RedisOperationBinding$1 = class RedisOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let RedisServerBinding$1 = class RedisServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SnsChannelBinding$1 = class SnsChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SnsMessageBinding$1 = class SnsMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SnsOperationBinding$1 = class SnsOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SnsServerBinding$1 = class SnsServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SolaceChannelBinding$1 = class SolaceChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SolaceMessageBinding$1 = class SolaceMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SolaceOperationBinding$1 = class SolaceOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SolaceServerBinding$1 = class SolaceServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SqsChannelBinding$1 = class SqsChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SqsMessageBinding$1 = class SqsMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SqsOperationBinding$1 = class SqsOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let SqsServerBinding$1 = class SqsServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let StompChannelBinding$1 = class StompChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let StompMessageBinding$1 = class StompMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let StompOperationBinding$1 = class StompOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let StompServerBinding$1 = class StompServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let WebSocketChannelBinding$1 = class WebSocketChannelBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let WebSocketMessageBinding$1 = class WebSocketMessageBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let WebSocketOperationBinding$1 = class WebSocketOperationBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  let WebSocketServerBinding$1 = class WebSocketServerBinding extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  const asyncApi2 = {
    namespace: options => {
       ...
       * AsyncApi >= 2.0.0 <=2.6.0 specification elements.
       */
      base.register('asyncApi2', AsyncApi2);
      base.register('asyncApiVersion', AsyncApiVersion$1);
      base.register('channelBindings', ChannelBindings$1);
      base.register('channelItem', ChannelItem);
      base.register('channels', Channels$1);
      base.register('components', Components$1);
      base.register('contact', Contact$1);
      base.register('correlationID', CorrelationID$1);
      base.register('defaultContentType', DefaultContentType$1);
      base.register('externalDocumentation', ExternalDocumentation$1);
      base.register('identifier', Identifier$1);
      base.register('info', Info$1);
      base.register('license', License$1);
      base.register('message', Message$1);
      base.register('messageBindings', MessageBindings$1);
      base.register('messageExample', MessageExample$1);
      base.register('messageTrait', MessageTrait$1);
      base.register('oAuthFlow', OAuthFlow$1);
      base.register('oAuthFlows', OAuthFlows$1);
      base.register('operation', Operation$1);
      base.register('operationBindings', OperationBindings$1);
      base.register('operationTrait', OperationTrait$1);
      base.register('parameter', Parameter$1);
      base.register('parameters', Parameters$1);
      ...
      base.register('serverBindings', ServerBindings$1);
      base.register('servers', Servers$1);
      base.register('serverVariable', ServerVariable$1);
      base.register('tag', Tag$1);
      base.register('tags', Tags$1);

      /**
       * Binding elements.
       */
      // AMQP 0-9-1
      base.register('amqpChannelBinding', AmqpChannelBinding$1);
      base.register('amqpMessageBinding', AmqpMessageBinding$1);
      base.register('amqpOperationBinding', AmqpOperationBinding$1);
      base.register('amqpServerBinding', AmqpServerBinding$1);
      // AMQP 1.0
      base.register('amqp1ChannelBinding', Amqp1ChannelBinding$1);
      base.register('amqp1MessageBinding', Amqp1MessageBinding$1);
      base.register('amqp1OperationBinding', Amqp1OperationBinding$1);
      base.register('amqp1ServerBinding', Amqp1ServerBinding$1);
      // Anypoint MQ
      base.register('anypointmqChannelBinding', AnypointmqChannelBinding$1);
      base.register('anypointmqMessageBinding', AnypointmqMessageBinding$1);
      base.register('anypointmqOperationBinding', AnypointmqOperationBinding$1);
      base.register('anypointmqServerBinding', AnypointmqServerBinding$1);
      // Google Cloud Pub/Sub
      base.register('googlepubsubChannelBinding', GooglepubsubChannelBinding$1);
      base.register('googlepubsubMessageBinding', GooglepubsubMessageBinding$1);
      base.register('googlepubsubOperationBinding', GooglepubsubOperationBinding$1);
      base.register('googlepubsubServerBinding', GooglepubsubServerBinding$1);
      // HTTP
      base.register('httpChannelBinding', HttpChannelBinding$1);
      base.register('httpMessageBinding', HttpMessageBinding$1);
      base.register('httpOperationBinding', HttpOperationBinding$1);
      base.register('httpServerBinding', HttpServerBinding$1);
      // IBM MQ
      base.register('ibmmqChannelBinding', IbmmqChannelBinding$1);
      base.register('ibmmqMessageBinding', IbmmqMessageBinding$1);
      base.register('ibmmqOperationBinding', IbmmqOperationBinding$1);
      base.register('ibmmqServerBinding', IbmmqServerBinding$1);
      // JMS
      base.register('jmsChannelBinding', JmsChannelBinding$1);
      base.register('jmsMessageBinding', JmsMessageBinding$1);
      base.register('jmsOperationBinding', JmsOperationBinding$1);
      base.register('jmsServerBinding', JmsServerBinding$1);
      // Kafka
      base.register('kafkaChannelBinding', KafkaChannelBinding$1);
      base.register('kafkaMessageBinding', KafkaMessageBinding$1);
      base.register('kafkaOperationBinding', KafkaOperationBinding$1);
      base.register('kafkaServerBinding', KafkaServerBinding$1);
      // Mercure
      base.register('mercureChannelBinding', MercureChannelBinding$1);
      base.register('mercureMessageBinding', MercureMessageBinding$1);
      base.register('mercureOperationBinding', MercureOperationBinding$1);
      base.register('mercureServerBinding', MercureServerBinding$1);
      // MQTT
      base.register('mqttChannelBinding', MqttChannelBinding$1);
      base.register('mqttMessageBinding', MqttMessageBinding$1);
      base.register('mqttOperationBinding', MqttOperationBinding$1);
      base.register('mqttServerBinding', MqttServerBinding$1);
      // MQTT 5
      base.register('mqtt5ChannelBinding', Mqtt5ChannelBinding$1);
      base.register('mqtt5MessageBinding', Mqtt5MessageBinding$1);
      base.register('mqtt5OperationBinding', Mqtt5OperationBinding$1);
      base.register('mqtt5ServerBinding', Mqtt5ServerBinding$1);
      // NATS
      base.register('natsChannelBinding', NatsChannelBinding$1);
      base.register('natsMessageBinding', NatsMessageBinding$1);
      base.register('natsOperationBinding', NatsOperationBinding$1);
      base.register('natsServerBinding', NatsServerBinding$1);
      // Pulsar
      base.register('pulsarChannelBinding', PulsarChannelBinding$1);
      base.register('pulsarMessageBinding', PulsarMessageBinding$1);
      base.register('pulsarOperationBinding', PulsarOperationBinding$1);
      base.register('pulsarServerBinding', PulsarServerBinding$1);
      // Redis
      base.register('redisChannelBinding', RedisChannelBinding$1);
      base.register('redisMessageBinding', RedisMessageBinding$1);
      base.register('redisOperationBinding', RedisOperationBinding$1);
      base.register('redisServerBinding', RedisServerBinding$1);
      // SNS
      base.register('snsChannelBinding', SnsChannelBinding$1);
      base.register('snsMessageBinding', SnsMessageBinding$1);
      base.register('snsOperationBinding', SnsOperationBinding$1);
      base.register('snsServerBinding', SnsServerBinding$1);
      // Solace
      base.register('solaceChannelBinding', SolaceChannelBinding$1);
      base.register('solaceMessageBinding', SolaceMessageBinding$1);
      base.register('solaceOperationBinding', SolaceOperationBinding$1);
      base.register('solaceServerBinding', SolaceServerBinding$1);
      // SQS
      base.register('sqsChannelBinding', SqsChannelBinding$1);
      base.register('sqsMessageBinding', SqsMessageBinding$1);
      base.register('sqsOperationBinding', SqsOperationBinding$1);
      base.register('sqsServerBinding', SqsServerBinding$1);
      // STOMP
      base.register('stompChannelBinding', StompChannelBinding$1);
      base.register('stompMessageBinding', StompMessageBinding$1);
      base.register('stompOperationBinding', StompOperationBinding$1);
      base.register('stompServerBinding', StompServerBinding$1);
      // WebSocket
      base.register('webSocketChannelBinding', WebSocketChannelBinding$1);
      base.register('webSocketMessageBinding', WebSocketMessageBinding$1);
      base.register('webSocketOperationBinding', WebSocketOperationBinding$1);
      base.register('webSocketServerBinding', WebSocketServerBinding$1);
      return base;
    }
  };
  ...
  class AsyncApiVersionVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    StringElement(stringElement) {
      const asyncApiVersionElement = new AsyncApiVersion$1(serializer(stringElement));
  ...
  class IdentifierVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    StringElement(stringElement) {
      const identifierElement = new Identifier$1(serializer(stringElement));
  ...
  class VersionVisitor extends FallbackVisitor {
    StringElement(stringElement) {
      this.element = new minimExports.StringElement(serializer(stringElement));
  ...
  class CorrelationIDVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new CorrelationID$1();
  ...
  class DefaultContentTypeVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    StringElement(stringElement) {
      const defaultContentTypeElement = new DefaultContentType$1(serializer(stringElement));
   ...
   * @public
   */
  const isAsyncApi2Element = createPredicate(({
    hasBasicElementProps,
    isElementType,
    primitiveEq,
    hasClass
  }) => {
    return element => element instanceof AsyncApi2 && element.constructor === AsyncApi2 || hasBasicElementProps(element) && isElementType('asyncApi2', element) && primitiveEq('object', element) && hasClass('api', element);
  });

  /**
   * @public
   */
  const isAsyncApiVersionElement$1 = createPredicate(({
    hasBasicElementProps,
    isElementType,
    primitiveEq
  }) => {
    return element => element instanceof AsyncApiVersion$1 || hasBasicElementProps(element) && isElementType('asyncApiVersion', element) && primitiveEq('string', element);
  });

  /**
   * @public
   */
  const isChannelBindingsElement$1 = createPredicate(({
    hasBasicElementProps,
    isElementType,
    primitiveEq
  }) => {
    return element => element instanceof ChannelBindings$1 || hasBasicElementProps(element) && isElementType('channelBindings', element) && primitiveEq('object', element);
  });

  /**
   * @public
   */
  const isChannelItemElement = createPredicate(({
    hasBasicElementProps,
    isElementType,
    primitiveEq
  }) => {
    return element => element instanceof ChannelItem || hasBasicElementProps(element) && isElementType('channelItem', element) && primitiveEq('object', element);
  });

  /**
   * @public
   */
  const isChannelsElement$1 = createPredicate(({
    hasBasicElementProps,
    isElementType,
    primitiveEq
  }) => {
    return element => element instanceof Channels$1 || hasBasicElementProps(element) && isElementType('channels', element) && primitiveEq('object', element);
  });
   ...
   * @public
   */
  const isIdentifierElement$1 = createPredicate(({
    hasBasicElementProps,
    isElementType,
    primitiveEq
  }) => {
    return element => element instanceof Identifier$1 || hasBasicElementProps(element) && isElementType('identifier', element) && primitiveEq('string', element);
  });
   ...
   * @public
   */
  const isParametersElement$1 = createPredicate(({
    hasBasicElementProps,
    isElementType,
    primitiveEq
  }) => {
    return element => element instanceof Parameters$1 || hasBasicElementProps(element) && isElementType('parameters', element) && primitiveEq('object', element);
  });
   ...
   * @public
   */
  const isServerBindingsElement$1 = createPredicate(({
    hasBasicElementProps,
    isElementType,
    primitiveEq
  }) => {
    return element => element instanceof ServerBindings$1 || hasBasicElementProps(element) && isElementType('serverBindings', element) && primitiveEq('object', element);
  });

  /**
   * @public
   */
  const isServersElement$1 = createPredicate(({
    hasBasicElementProps,
    isElementType,
    primitiveEq
  }) => {
    return element => element instanceof Servers$1 || hasBasicElementProps(element) && isElementType('servers', element) && primitiveEq('object', element);
  });
  ...
  const asyncApi2Predicates = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    isAsyncApi2Element,
    isAsyncApiVersionElement: isAsyncApiVersionElement$1,
    isBooleanJsonSchemaElement,
    isChannelBindingsElement: isChannelBindingsElement$1,
    isChannelItemElement,
    isChannelsElement: isChannelsElement$1,
    isComponentsElement: isComponentsElement$1,
    isContactElement: isContactElement$1,
    isIdentifierElement: isIdentifierElement$1,
   ...
   * @public
   */
  let ServersVisitor$2 = class ServersVisitor extends Mixin(PatternedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Servers$1();
   ...
   * @public
   */
  let BindingsVisitor$5 = class BindingsVisitor extends Mixin(AlternatingVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.alternator = [{
   ...
   * @public
   */
  class ServerSecurity extends minimExports.ArrayElement {
   ...
   * @public
   */
  let SecurityVisitor$2 = class SecurityVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ServerSecurity();
    }
    ArrayElement(arrayElement) {
      arrayElement.forEach(item => {
   ...
   * @public
   */
  let ServerBindingsVisitor$1 = class ServerBindingsVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ServerBindings$1();
   ...
   */
  // eslint-disable-next-line prefer-destructuring
  const JSONSchemaOrJSONReferenceVisitor = specification$1.visitors.JSONSchemaOrJSONReferenceVisitor;
   ...
   * @public
   */
  const JSONSchemaAllOfVisitor = specification$1.visitors.document.objects.JSONSchema.fixedFields.allOf;
   ...
   * @public
   */
  const JSONSchemaAnyOfVisitor = specification$1.visitors.document.objects.JSONSchema.fixedFields.anyOf;
   ...
   * @public
   */
  const JSONSchemaOneOfVisitor = specification$1.visitors.document.objects.JSONSchema.fixedFields.oneOf;
   ...
   * @public
   */
  const JSONSchemaDefinitionsVisitor = specification$1.visitors.document.objects.JSONSchema.fixedFields.definitions;
   ...
   * @public
   */
  const JSONSchemaDependenciesVisitor = specification$1.visitors.document.objects.JSONSchema.fixedFields.dependencies;
   ...
   * @public
   */
  const JSONSchemaItemsVisitor = specification$1.visitors.document.objects.JSONSchema.fixedFields.items;
   ...
   * @public
   */
  const JSONSchemaPatternPropertiesVisitor = specification$1.visitors.document.objects.JSONSchema.fixedFields.patternProperties;
   ...
   * @public
   */
  const JSONSchemaPropertiesVisitor = specification$1.visitors.document.objects.JSONSchema.fixedFields.properties;
  ...
  const inheritedFixedFields = map(visitor => {
    if (visitor === specification$1.visitors.JSONSchemaOrJSONReferenceVisitor) {
      return SchemaOrReferenceVisitor;
    }
    return visitor;
  }, specification$1.visitors.document.objects.JSONSchema.fixedFields);
   ...
   * @public
   */
  let ParametersVisitor$1 = class ParametersVisitor extends Mixin(PatternedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Parameters$1();
   ...
   * @public
   */
  let ComponentsSchemas$1 = class ComponentsSchemas extends minimExports.ObjectElement {
  ...
  class SchemasVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsSchemas$1();
   ...
   * @public
   */
  class ComponentsServers extends minimExports.ObjectElement {
   ...
   * @public
   */
  let ServersVisitor$1 = class ServersVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsServers();
   ...
   * @public
   */
  class ComponentsServerVariables extends minimExports.ObjectElement {
  ...
  class ServerVariablesVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsServerVariables();
   ...
   * @public
   */
  class ComponentsChannels extends minimExports.ObjectElement {
   ...
   * @public
   */
  let ChannelsVisitor$1 = class ChannelsVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsChannels();
   ...
   * @public
   */
  class ComponentsMessages extends minimExports.ObjectElement {
  ...
  class MessagesVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsMessages();
   ...
   * @public
   */
  class ComponentsCorrelationIDs extends minimExports.ObjectElement {
  ...
  class CorrelationIdsVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsCorrelationIDs();
   ...
   * @public
   */
  class ComponentsOperationTraits extends minimExports.ObjectElement {
  ...
  class OperationTraitsVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsOperationTraits();
   ...
   * @public
   */
  class ComponentsMessageTraits extends minimExports.ObjectElement {
  ...
  class MessageTraitsVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsMessageTraits();
   ...
   * @public
   */
  class ComponentsServerBindings extends minimExports.ObjectElement {
  ...
  class ServerBindingsVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsServerBindings();
   ...
   * @public
   */
  class ComponentsChannelBindings extends minimExports.ObjectElement {
   ...
   * @public
   */
  let ChannelBindingsVisitor$1 = class ChannelBindingsVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsChannelBindings();
   ...
   * @public
   */
  class ComponentsOperationBindings extends minimExports.ObjectElement {
   ...
   * @public
   */
  let OperationBindingsVisitor$1 = class OperationBindingsVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsOperationBindings();
   ...
   * @public
   */
  class ComponentsMessageBindings extends minimExports.ObjectElement {
   ...
   * @public
   */
  let MessageBindingsVisitor$1 = class MessageBindingsVisitor extends Mixin(MapVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ComponentsMessageBindings();
   ...
   * @public
   */
  let OperationSecurity$1 = class OperationSecurity extends minimExports.ArrayElement {
  ...
  let SecurityVisitor$1 = class SecurityVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new OperationSecurity$1();
    }
    ArrayElement(arrayElement) {
      arrayElement.forEach(item => {
        const securityRequirementElement = this.toRefractedElement(['document', 'objects', 'SecurityRequirement'], item);
   ...
   * @public
   */
  let BindingsVisitor$4 = class BindingsVisitor extends Mixin(AlternatingVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.alternator = [{
        predicate: isReferenceLikeElement,
        ...
        predicate: T,
        specPath: ['document', 'objects', 'OperationBindings']
      }];
    }
    ObjectElement(objectElement) {
      const result = AlternatingVisitor.prototype.enter.call(this, objectElement);
   ...
   * @public
   */
  let OperationTraits$1 = class OperationTraits extends minimExports.ArrayElement {
   ...
   * @public
   */
  let TraitsVisitor$1 = class TraitsVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new OperationTraits$1();
    }
    ArrayElement(arrayElement) {
      arrayElement.forEach(item => {
        let element;
   ...
   * @public
   */
  class OperationMessageMap extends minimExports.ObjectElement {
   ...
   * @public
   */
  class OperationMessage extends minimExports.ArrayElement {
   ...
   * @public
   */
  let MessageVisitor$1 = class MessageVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    ObjectElement(objectElement) {
      if (isReferenceLikeElement(objectElement)) {
        ...
        this.element = new OperationMessageMap();
        const operationMessageElement = new OperationMessage();
  ...
  class ChannelBindingsVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ChannelBindings$1();
   ...
   * @public
   */
  class ChannelItemServers extends minimExports.ArrayElement {
  ...
  class ServersVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new ChannelItemServers();
    }
    ArrayElement(arrayElement) {
      arrayElement.forEach(item => {
   ...
   * @public
   */
  let BindingsVisitor$3 = class BindingsVisitor extends Mixin(AlternatingVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.alternator = [{
        predicate: isReferenceLikeElement,
        ...
        predicate: T,
        specPath: ['document', 'objects', 'ChannelBindings']
      }];
    }
    ObjectElement(objectElement) {
      const result = AlternatingVisitor.prototype.enter.call(this, objectElement);
  ...
  class MessageBindingsVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MessageBindings$1();
  ...
  class MessageExampleVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MessageExample$1();
  ...
  class MessageTraitVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MessageTrait$1();
   ...
   * @public
   */
  let CorrelationIdVisitor$1 = class CorrelationIdVisitor extends Mixin(AlternatingVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.alternator = [{
        predicate: isReferenceLikeElement,
   ...
   * @public
   */
  let BindingsVisitor$2 = class BindingsVisitor extends Mixin(AlternatingVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.alternator = [{
        predicate: isReferenceLikeElement,
   ...
   * @public
   */
  class MessageTraitExamples extends minimExports.ArrayElement {
   ...
   * @public
   */
  let ExamplesVisitor$1 = class ExamplesVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MessageTraitExamples();
    }
    ArrayElement(arrayElement) {
      arrayElement.forEach(item => {
  ...
  class MessageVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    ...
    ObjectElement(objectElement) {
      ...
      const schemaFormat = defaultTo(mediaTypes.latest(), serializer(objectElement.get('schemaFormat')));
   ...
   * @public
   */
  let BindingsVisitor$1 = class BindingsVisitor extends Mixin(AlternatingVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.alternator = [{
        predicate: isReferenceLikeElement,
   ...
   * @public
   */
  let MessageExamples$1 = class MessageExamples extends minimExports.ArrayElement {
  ...
  class ExamplesVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MessageExamples$1();
    }
    ArrayElement(arrayElement) {
      arrayElement.forEach(item => {
   ...
   * @public
   */
  let MessageTraits$1 = class MessageTraits extends minimExports.ArrayElement {
  ...
  class TraitsVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MessageTraits$1();
    }
    ArrayElement(arrayElement) {
      arrayElement.forEach(item => {
        let element;
  ...
  class OperationBindingsVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new OperationBindings$1();
  ...
  class OperationTraitVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new OperationTrait$1();
   ...
   * @public
   */
  let OperationTraitSecurity$1 = class OperationTraitSecurity extends minimExports.ArrayElement {
  ...
  class SecurityVisitor extends Mixin(SpecificationVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new OperationTraitSecurity$1();
    }
    ArrayElement(arrayElement) {
      arrayElement.forEach(item => {
        const securityRequirementElement = this.toRefractedElement(['document', 'objects', 'SecurityRequirement'], item);
  ...
  class AmqpChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new AmqpChannelBinding$1();
  ...
  class AmqpMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new AmqpMessageBinding$1();
  ...
  class AmqpOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new AmqpOperationBinding$1();
  ...
  class AmqpServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new AmqpServerBinding$1();
  ...
  class Amqp1ChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Amqp1ChannelBinding$1();
  ...
  class Amqp1MessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Amqp1MessageBinding$1();
  ...
  class Amqp1OperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Amqp1OperationBinding$1();
  ...
  class Amqp1ServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Amqp1ServerBinding$1();
  ...
  class AnypointmqChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new AnypointmqChannelBinding$1();
  ...
  class AnypointmqMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new AnypointmqMessageBinding$1();
  ...
  class AnypointmqOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new AnypointmqOperationBinding$1();
  ...
  class AnypointmqServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new AnypointmqServerBinding$1();
  ...
  class HttpChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new HttpChannelBinding$1();
  ...
  class HttpMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new HttpMessageBinding$1();
  ...
  class HttpOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new HttpOperationBinding$1();
  ...
  class HttpServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new HttpServerBinding$1();
  ...
  class GooglepubsubChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new GooglepubsubChannelBinding$1();
  ...
  class GooglepubsubMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new GooglepubsubMessageBinding$1();
  ...
  class GooglepubsubOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new GooglepubsubOperationBinding$1();
  ...
  class GooglepubsubServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new GooglepubsubServerBinding$1();
  ...
  class IbmmqChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new IbmmqChannelBinding$1();
  ...
  class IbmmqMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new IbmmqMessageBinding$1();
  ...
  class IbmmqOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new IbmmqOperationBinding$1();
  ...
  class IbmmqServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new IbmmqServerBinding$1();
  ...
  class JmsChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new JmsChannelBinding$1();
  ...
  class JmsMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new JmsMessageBinding$1();
  ...
  class JmsOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new JmsOperationBinding$1();
  ...
  class JmsServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new JmsServerBinding$1();
  ...
  class KafkaChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new KafkaChannelBinding$1();
  ...
  class KafkaMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new KafkaMessageBinding$1();
  ...
  class KafkaOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new KafkaOperationBinding$1();
  ...
  class KafkaServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new KafkaServerBinding$1();
  ...
  class MercureChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MercureChannelBinding$1();
  ...
  class MercureMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MercureMessageBinding$1();
  ...
  class MercureOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MercureOperationBinding$1();
  ...
  class MercureServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MercureServerBinding$1();
  ...
  class MqttChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MqttChannelBinding$1();
  ...
  class MqttMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MqttMessageBinding$1();
  ...
  class MqttOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MqttOperationBinding$1();
  ...
  class MqttServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new MqttServerBinding$1();
  ...
  class Mqtt5ChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Mqtt5ChannelBinding$1();
  ...
  class Mqtt5MessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Mqtt5MessageBinding$1();
  ...
  class Mqtt5OperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Mqtt5OperationBinding$1();
  ...
  class Mqtt5ServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new Mqtt5ServerBinding$1();
  ...
  class NatsChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new NatsChannelBinding$1();
  ...
  class NatsMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new NatsMessageBinding$1();
  ...
  class NatsOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new NatsOperationBinding$1();
  ...
  class NatsServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new NatsServerBinding$1();
  ...
  class PulsarChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new PulsarChannelBinding$1();
  ...
  class PulsarMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new PulsarMessageBinding$1();
  ...
  class PulsarOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new PulsarOperationBinding$1();
  ...
  class PulsarServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new PulsarServerBinding$1();
  ...
  class RedisChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new RedisChannelBinding$1();
  ...
  class RedisMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new RedisMessageBinding$1();
  ...
  class RedisOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new RedisOperationBinding$1();
  ...
  class RedisServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new RedisServerBinding$1();
  ...
  class SnsChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SnsChannelBinding$1();
  ...
  class SnsMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SnsMessageBinding$1();
  ...
  class SnsOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SnsOperationBinding$1();
  ...
  class SnsServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SnsServerBinding$1();
  ...
  class SolaceChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SolaceChannelBinding$1();
  ...
  class SolaceMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SolaceMessageBinding$1();
  ...
  class SolaceOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SolaceOperationBinding$1();
  ...
  class SolaceServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SolaceServerBinding$1();
  ...
  class SqsChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SqsChannelBinding$1();
  ...
  class SqsMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SqsMessageBinding$1();
  ...
  class SqsOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SqsOperationBinding$1();
  ...
  class SqsServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new SqsServerBinding$1();
  ...
  class StompChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new StompChannelBinding$1();
  ...
  class StompMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new StompMessageBinding$1();
  ...
  class StompOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new StompOperationBinding$1();
  ...
  class StompServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new StompServerBinding$1();
  ...
  class WebSocketChannelBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new WebSocketChannelBinding$1();
  ...
  class WebSocketMessageBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new WebSocketMessageBinding$1();
  ...
  class WebSocketOperationBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new WebSocketOperationBinding$1();
  ...
  class WebSocketServerBindingVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
      this.element = new WebSocketServerBinding$1();
        ...
        objects: {
          ...
          Operation: {
            ...
            fixedFields: {
              ...
              bindings: BindingsVisitor$4,
              traits: TraitsVisitor$1,
              message: MessageVisitor$1
            }
          },
          OperationTrait: {
          ...
          Message: {
            ...
            fixedFields: {
              ...
              correlationId: CorrelationIdVisitor,
              schemaFormat: {
                $ref: '#/visitors/value'
              },
              contentType: {
              ...
              bindings: BindingsVisitor$1,
              examples: ExamplesVisitor,
              traits: TraitsVisitor
            }
          },
          MessageTrait: {
            ...
            fixedFields: {
              ...
              headers: DefaultVisitor,
              correlationId: CorrelationIdVisitor$1,
              schemaFormat: {
                $ref: '#/visitors/value'
              },
              contentType: {
          ...
          Components: {
            ...
            fixedFields: {
              ...
              serverVariables: ServerVariablesVisitor,
              channels: ChannelsVisitor$1,
              messages: MessagesVisitor,
              securitySchemes: SecuritySchemesVisitor,
              parameters: ParametersVisitor,
              correlationIds: CorrelationIdsVisitor,
              operationTraits: OperationTraitsVisitor,
              messageTraits: MessageTraitsVisitor,
              serverBindings: ServerBindingsVisitor,
              channelBindings: ChannelBindingsVisitor$1,
              operationBindings: OperationBindingsVisitor$1,
              messageBindings: MessageBindingsVisitor$1
            }
          },
          ...
          LinkDescription: specification$1.visitors.document.objects.LinkDescription,
          SecurityScheme: {
          ...
          ServerBindings: {
            $visitor: ServerBindingsVisitor$1,
            fixedFields: {
              http: {
  ...
  const createToolbox = () => {
    const namespace = createNamespace(asyncApi2);
    const predicates = {
      ...asyncApi2Predicates,
      isStringElement
    };
   ...
   * AsyncApi >= 2.0.0 <=2.6.0 specification elements.
   */
  AsyncApi2.refract = createRefractor(['visitors', 'document', 'objects', 'AsyncApi', '$visitor']);
  AsyncApiVersion$1.refract = createRefractor(['visitors', 'document', 'objects', 'AsyncApiVersion', '$visitor']);
  ChannelBindings$1.refract = createRefractor(['visitors', 'document', 'objects', 'ChannelBindings', '$visitor']);
  ChannelItem.refract = createRefractor(['visitors', 'document', 'objects', 'ChannelItem', '$visitor']);
  Channels$1.refract = createRefractor(['visitors', 'document', 'objects', 'Channels', '$visitor']);
  Components$1.refract = createRefractor(['visitors', 'document', 'objects', 'Components', '$visitor']);
  Contact$1.refract = createRefractor(['visitors', 'document', 'objects', 'Contact', '$visitor']);
  CorrelationID$1.refract = createRefractor(['visitors', 'document', 'objects', 'CorrelationID', '$visitor']);
  DefaultContentType$1.refract = createRefractor(['visitors', 'document', 'objects', 'DefaultContentType', '$visitor']);
  ExternalDocumentation$1.refract = createRefractor(['visitors', 'document', 'objects', 'ExternalDocumentation', '$visitor']);
  Identifier$1.refract = createRefractor(['visitors', 'document', 'objects', 'Identifier', '$visitor']);
  Info$1.refract = createRefractor(['visitors', 'document', 'objects', 'Info', '$visitor']);
  License$1.refract = createRefractor(['visitors', 'document', 'objects', 'License', '$visitor']);
  Message$1.refract = createRefractor(['visitors', 'document', 'objects', 'Message', '$visitor']);
  MessageBindings$1.refract = createRefractor(['visitors', 'document', 'objects', 'MessageBindings', '$visitor']);
  MessageExample$1.refract = createRefractor(['visitors', 'document', 'objects', 'MessageExample', '$visitor']);
  MessageTrait$1.refract = createRefractor(['visitors', 'document', 'objects', 'MessageTrait', '$visitor']);
  OAuthFlow$1.refract = createRefractor(['visitors', 'document', 'objects', 'OAuthFlow', '$visitor']);
  OAuthFlows$1.refract = createRefractor(['visitors', 'document', 'objects', 'OAuthFlows', '$visitor']);
  Operation$1.refract = createRefractor(['visitors', 'document', 'objects', 'Operation', '$visitor']);
  OperationBindings$1.refract = createRefractor(['visitors', 'document', 'objects', 'OperationBindings', '$visitor']);
  OperationTrait$1.refract = createRefractor(['visitors', 'document', 'objects', 'OperationTrait', '$visitor']);
  Parameter$1.refract = createRefractor(['visitors', 'document', 'objects', 'Parameter', '$visitor']);
  Parameters$1.refract = createRefractor(['visitors', 'document', 'objects', 'Parameters', '$visitor']);
  Reference$1.refract = createRefractor(['visitors', 'document', 'objects', 'Reference', '$visitor']);
  Schema$1.refract = createRefractor(['visitors', 'document', 'objects', 'Schema', '$visitor']);
  SecurityRequirement.refract = createRefractor(['visitors', 'document', 'objects', 'SecurityRequirement', '$visitor']);
  SecurityScheme$1.refract = createRefractor(['visitors', 'document', 'objects', 'SecurityScheme', '$visitor']);
  Server$1.refract = createRefractor(['visitors', 'document', 'objects', 'Server', '$visitor']);
  ServerBindings$1.refract = createRefractor(['visitors', 'document', 'objects', 'ServerBindings', '$visitor']);
  Servers$1.refract = createRefractor(['visitors', 'document', 'objects', 'Servers', '$visitor']);
  ServerVariable$1.refract = createRefractor(['visitors', 'document', 'objects', 'ServerVariable', '$visitor']);
  Tag$1.refract = createRefractor(['visitors', 'document', 'objects', 'Tag', '$visitor']);
  Tags$1.refract = createRefractor(['visitors', 'document', 'objects', 'Tags', '$visitor']);

  /**
   * Binding elements.
   */
  // AMQP 0-9-1
  AmqpChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'amqp', 'ChannelBinding', '$visitor']);
  AmqpMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'amqp', 'MessageBinding', '$visitor']);
  AmqpOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'amqp', 'OperationBinding', '$visitor']);
  AmqpServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'amqp', 'ServerBinding', '$visitor']);
  // AMQP 1.0
  Amqp1ChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'amqp1', 'ChannelBinding', '$visitor']);
  Amqp1MessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'amqp1', 'MessageBinding', '$visitor']);
  Amqp1OperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'amqp1', 'OperationBinding', '$visitor']);
  Amqp1ServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'amqp1', 'ServerBinding', '$visitor']);
  // HTTP
  HttpChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'http', 'ChannelBinding', '$visitor']);
  HttpMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'http', 'MessageBinding', '$visitor']);
  HttpOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'http', 'OperationBinding', '$visitor']);
  HttpServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'http', 'ServerBinding', '$visitor']);
  // Google Cloud Pub/Sub
  GooglepubsubChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'googlepubsub', 'ChannelBinding', '$visitor']);
  GooglepubsubMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'googlepubsub', 'MessageBinding', '$visitor']);
  GooglepubsubOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'googlepubsub', 'OperationBinding', '$visitor']);
  GooglepubsubServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'googlepubsub', 'ServerBinding', '$visitor']);
  // IBM MQ
  IbmmqChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'ibmmq', 'ChannelBinding', '$visitor']);
  IbmmqMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'ibmmq', 'MessageBinding', '$visitor']);
  IbmmqOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'ibmmq', 'OperationBinding', '$visitor']);
  IbmmqServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'ibmmq', 'ServerBinding', '$visitor']);
  // JMS
  JmsChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'jms', 'ChannelBinding', '$visitor']);
  JmsMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'jms', 'MessageBinding', '$visitor']);
  JmsOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'jms', 'OperationBinding', '$visitor']);
  JmsServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'jms', 'ServerBinding', '$visitor']);
  // Kafka
  KafkaChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'kafka', 'ChannelBinding', '$visitor']);
  KafkaMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'kafka', 'MessageBinding', '$visitor']);
  KafkaOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'kafka', 'OperationBinding', '$visitor']);
  KafkaServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'kafka', 'ServerBinding', '$visitor']);
  // Anypoint MQ
  AnypointmqChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'anypointmq', 'ChannelBinding', '$visitor']);
  AnypointmqMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'anypointmq', 'MessageBinding', '$visitor']);
  AnypointmqOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'anypointmq', 'OperationBinding', '$visitor']);
  AnypointmqServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'anypointmq', 'ServerBinding', '$visitor']);
  // Mercure
  MercureChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mercure', 'ChannelBinding', '$visitor']);
  MercureMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mercure', 'MessageBinding', '$visitor']);
  MercureOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mercure', 'OperationBinding', '$visitor']);
  MercureServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mercure', 'ServerBinding', '$visitor']);
  // MQTT
  MqttChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mqtt', 'ChannelBinding', '$visitor']);
  MqttMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mqtt', 'MessageBinding', '$visitor']);
  MqttOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mqtt', 'OperationBinding', '$visitor']);
  MqttServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mqtt', 'ServerBinding', '$visitor']);
  // MQTT 5
  Mqtt5ChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mqtt5', 'ChannelBinding', '$visitor']);
  Mqtt5MessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mqtt5', 'MessageBinding', '$visitor']);
  Mqtt5OperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mqtt5', 'OperationBinding', '$visitor']);
  Mqtt5ServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'mqtt5', 'ServerBinding', '$visitor']);
  // NATS
  NatsChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'nats', 'ChannelBinding', '$visitor']);
  NatsMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'nats', 'MessageBinding', '$visitor']);
  NatsOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'nats', 'OperationBinding', '$visitor']);
  NatsServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'nats', 'ServerBinding', '$visitor']);
  // Pulsar
  PulsarChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'pulsar', 'ChannelBinding', '$visitor']);
  PulsarMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'pulsar', 'MessageBinding', '$visitor']);
  PulsarOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'pulsar', 'OperationBinding', '$visitor']);
  PulsarServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'pulsar', 'ServerBinding', '$visitor']);
  // Redis
  RedisChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'redis', 'ChannelBinding', '$visitor']);
  RedisMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'redis', 'MessageBinding', '$visitor']);
  RedisOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'redis', 'OperationBinding', '$visitor']);
  RedisServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'redis', 'ServerBinding', '$visitor']);
  // SNS
  SnsChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'sns', 'ChannelBinding', '$visitor']);
  SnsMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'sns', 'MessageBinding', '$visitor']);
  SnsOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'sns', 'OperationBinding', '$visitor']);
  SnsServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'sns', 'ServerBinding', '$visitor']);
  // Solace
  SolaceChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'solace', 'ChannelBinding', '$visitor']);
  SolaceMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'solace', 'MessageBinding', '$visitor']);
  SolaceOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'solace', 'OperationBinding', '$visitor']);
  SolaceServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'solace', 'ServerBinding', '$visitor']);
  // SQS
  SqsChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'sqs', 'ChannelBinding', '$visitor']);
  SqsMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'sqs', 'MessageBinding', '$visitor']);
  SqsOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'sqs', 'OperationBinding', '$visitor']);
  SqsServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'sqs', 'ServerBinding', '$visitor']);
  // STOMP
  StompChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'stomp', 'ChannelBinding', '$visitor']);
  StompMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'stomp', 'MessageBinding', '$visitor']);
  StompOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'stomp', 'OperationBinding', '$visitor']);
  StompServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'stomp', 'ServerBinding', '$visitor']);
  // WebSocket
  WebSocketChannelBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'ws', 'ChannelBinding', '$visitor']);
  WebSocketMessageBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'ws', 'MessageBinding', '$visitor']);
  WebSocketOperationBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'ws', 'OperationBinding', '$visitor']);
  WebSocketServerBinding$1.refract = createRefractor(['visitors', 'document', 'objects', 'bindings', 'ws', 'ServerBinding', '$visitor']);

  class AsyncApi3 extends AsyncApi2 {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  class AsyncApiVersion extends AsyncApiVersion$1 {
  }

  class Channel extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  class ChannelBindings extends ChannelBindings$1 {
  }

  class Channels extends Channels$1 {
  }
  ...
  class CorrelationID extends CorrelationID$1 {
  }

  class DefaultContentType extends DefaultContentType$1 {
  }

  class ExternalDocumentation extends ExternalDocumentation$1 {
  }

  class Identifier extends Identifier$1 {
  }
  ...
  class MessageBindings extends MessageBindings$1 {
  }

  class MessageExample extends MessageExample$1 {
  }

  class MessageTrait extends MessageTrait$1 {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = "messageTrait";
    }
  ...
  class Messages extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  class MultiFormatSchema extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  class Operation extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = "operation";
    }
  ...
  class OperationBindings extends OperationBindings$1 {
  }

  class OperationReply extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  class OperationReplyAddress extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  class Operations extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  class OperationTrait extends OperationTrait$1 {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = "operationTrait";
    }
  ...
  class Parameter extends minimExports.ObjectElement {
    constructor(content = {}, meta, attributes) {
      super(content, meta, attributes);
      this.element = "parameter";
    }
  ...
  class Parameters extends Parameters$1 {
  }
  ...
  class ServerBindings extends ServerBindings$1 {
  }

  class Servers extends Servers$1 {
  }
  ...
  class Tags extends Tags$1 {
  }

  class AmqpChannelBinding extends AmqpChannelBinding$1 {
  }

  class AmqpMessageBinding extends AmqpMessageBinding$1 {
  }

  class AmqpOperationBinding extends AmqpOperationBinding$1 {
  }

  class AmqpServerBinding extends AmqpServerBinding$1 {
  }

  class Amqp1ChannelBinding extends Amqp1ChannelBinding$1 {
  }

  class Amqp1MessageBinding extends Amqp1MessageBinding$1 {
  }

  class Amqp1OperationBinding extends Amqp1OperationBinding$1 {
  }

  class Amqp1ServerBinding extends Amqp1ServerBinding$1 {
  }

  class AnypointmqChannelBinding extends AnypointmqChannelBinding$1 {
  }

  class AnypointmqMessageBinding extends AnypointmqMessageBinding$1 {
  }

  class AnypointmqOperationBinding extends AnypointmqOperationBinding$1 {
  }

  class AnypointmqServerBinding extends AnypointmqServerBinding$1 {
  }

  class GooglepubsubChannelBinding extends GooglepubsubChannelBinding$1 {
  }

  class GooglepubsubMessageBinding extends GooglepubsubMessageBinding$1 {
  }

  class GooglepubsubOperationBinding extends GooglepubsubOperationBinding$1 {
  }

  class GooglepubsubServerBinding extends GooglepubsubServerBinding$1 {
  }

  class HttpChannelBinding extends HttpChannelBinding$1 {
  }

  class HttpMessageBinding extends HttpMessageBinding$1 {
  }

  class HttpOperationBinding extends HttpOperationBinding$1 {
  }

  class HttpServerBinding extends HttpServerBinding$1 {
  }

  class IbmmqChannelBinding extends IbmmqChannelBinding$1 {
  }

  class IbmmqMessageBinding extends IbmmqMessageBinding$1 {
  }

  class IbmmqOperationBinding extends IbmmqOperationBinding$1 {
  }

  class IbmmqServerBinding extends IbmmqServerBinding$1 {
  }

  class JmsChannelBinding extends JmsChannelBinding$1 {
  }

  class JmsMessageBinding extends JmsMessageBinding$1 {
  }

  class JmsOperationBinding extends JmsOperationBinding$1 {
  }

  class JmsServerBinding extends JmsServerBinding$1 {
  }

  class KafkaChannelBinding extends KafkaChannelBinding$1 {
  }

  class KafkaMessageBinding extends KafkaMessageBinding$1 {
  }

  class KafkaOperationBinding extends KafkaOperationBinding$1 {
  }

  class KafkaServerBinding extends KafkaServerBinding$1 {
  }

  class MercureChannelBinding extends MercureChannelBinding$1 {
  }

  class MercureMessageBinding extends MercureMessageBinding$1 {
  }

  class MercureOperationBinding extends MercureOperationBinding$1 {
  }

  class MercureServerBinding extends MercureServerBinding$1 {
  }

  class MqttChannelBinding extends MqttChannelBinding$1 {
  }

  class MqttMessageBinding extends MqttMessageBinding$1 {
  }

  class MqttOperationBinding extends MqttOperationBinding$1 {
  }

  class MqttServerBinding extends MqttServerBinding$1 {
  }

  class Mqtt5ChannelBinding extends Mqtt5ChannelBinding$1 {
  }

  class Mqtt5MessageBinding extends Mqtt5MessageBinding$1 {
  }

  class Mqtt5OperationBinding extends Mqtt5OperationBinding$1 {
  }

  class Mqtt5ServerBinding extends Mqtt5ServerBinding$1 {
  }

  class NatsChannelBinding extends NatsChannelBinding$1 {
  }

  class NatsMessageBinding extends NatsMessageBinding$1 {
  }

  class NatsOperationBinding extends NatsOperationBinding$1 {
  }

  class NatsServerBinding extends NatsServerBinding$1 {
  }

  class PulsarChannelBinding extends PulsarChannelBinding$1 {
  }

  class PulsarMessageBinding extends PulsarMessageBinding$1 {
  }

  class PulsarOperationBinding extends PulsarOperationBinding$1 {
  }

  class PulsarServerBinding extends PulsarServerBinding$1 {
  }

  class RedisChannelBinding extends RedisChannelBinding$1 {
  }

  class RedisMessageBinding extends RedisMessageBinding$1 {
  }

  class RedisOperationBinding extends RedisOperationBinding$1 {
  }

  class RedisServerBinding extends RedisServerBinding$1 {
  }

  class SnsChannelBinding extends SnsChannelBinding$1 {
  }

  class SnsMessageBinding extends SnsMessageBinding$1 {
  }

  class SnsOperationBinding extends SnsOperationBinding$1 {
  }

  class SnsServerBinding extends SnsServerBinding$1 {
  }

  class SolaceChannelBinding extends SolaceChannelBinding$1 {
  }

  class SolaceMessageBinding extends SolaceMessageBinding$1 {
  }

  class SolaceOperationBinding extends SolaceOperationBinding$1 {
  }

  class SolaceServerBinding extends SolaceServerBinding$1 {
  }

  class SqsChannelBinding extends SqsChannelBinding$1 {
  }

  class SqsMessageBinding extends SqsMessageBinding$1 {
  }

  class SqsOperationBinding extends SqsOperationBinding$1 {
  }

  class SqsServerBinding extends SqsServerBinding$1 {
  }

  class StompChannelBinding extends StompChannelBinding$1 {
  }

  class StompMessageBinding extends StompMessageBinding$1 {
  }

  class StompOperationBinding extends StompOperationBinding$1 {
  }

  class StompServerBinding extends StompServerBinding$1 {
  }

  class WebSocketChannelBinding extends WebSocketChannelBinding$1 {
  }

  class WebSocketMessageBinding extends WebSocketMessageBinding$1 {
  }

  class WebSocketOperationBinding extends WebSocketOperationBinding$1 {
  }

  class WebSocketServerBinding extends WebSocketServerBinding$1 {
  }

  const asyncApi3 = {
    namespace: (options) => {
      const { base } = options;
      base.register("asyncApi3", AsyncApi3);
      base.register("asyncApiVersion", AsyncApiVersion);
      base.register("channel", Channel);
      ...
      base.register("correlationID", CorrelationID);
      base.register("defaultContentType", DefaultContentType);
      ...
      base.register("message", Message);
      base.register("messageBindings", MessageBindings);
      base.register("messageExample", MessageExample);
      base.register("messages", Messages);
      base.register("messageTrait", MessageTrait);
      base.register("multiFormatSchema", MultiFormatSchema);
      base.register("oAuthFlow", OAuthFlow);
      base.register("oAuthFlows", OAuthFlows);
      base.register("operation", Operation);
      base.register("operationBindings", OperationBindings);
      base.register("operationReply", OperationReply);
      base.register("operationReplyAddress", OperationReplyAddress);
      base.register("operations", Operations);
      base.register("operationTrait", OperationTrait);
      ...
      base.register("tags", Tags);
      base.register("amqpChannelBinding", AmqpChannelBinding);
      base.register("amqpMessageBinding", AmqpMessageBinding);
      base.register("amqpOperationBinding", AmqpOperationBinding);
      base.register("amqpServerBinding", AmqpServerBinding);
      base.register("amqp1ChannelBinding", Amqp1ChannelBinding);
      base.register("amqp1MessageBinding", Amqp1MessageBinding);
      base.register("amqp1OperationBinding", Amqp1OperationBinding);
      base.register("amqp1ServerBinding", Amqp1ServerBinding);
      base.register("anypointmqChannelBinding", AnypointmqChannelBinding);
      base.register("anypointmqMessageBinding", AnypointmqMessageBinding);
      base.register("anypointmqOperationBinding", AnypointmqOperationBinding);
      base.register("anypointmqServerBinding", AnypointmqServerBinding);
      base.register("googlepubsubChannelBinding", GooglepubsubChannelBinding);
      base.register("googlepubsubMessageBinding", GooglepubsubMessageBinding);
      base.register("googlepubsubOperationBinding", GooglepubsubOperationBinding);
      base.register("googlepubsubServerBinding", GooglepubsubServerBinding);
      base.register("httpChannelBinding", HttpChannelBinding);
      base.register("httpMessageBinding", HttpMessageBinding);
      base.register("httpOperationBinding", HttpOperationBinding);
      base.register("httpServerBinding", HttpServerBinding);
      base.register("ibmmqChannelBinding", IbmmqChannelBinding);
      base.register("ibmmqMessageBinding", IbmmqMessageBinding);
      base.register("ibmmqOperationBinding", IbmmqOperationBinding);
      base.register("ibmmqServerBinding", IbmmqServerBinding);
      base.register("jmsChannelBinding", JmsChannelBinding);
      base.register("jmsMessageBinding", JmsMessageBinding);
      base.register("jmsOperationBinding", JmsOperationBinding);
      base.register("jmsServerBinding", JmsServerBinding);
      base.register("kafkaChannelBinding", KafkaChannelBinding);
      base.register("kafkaMessageBinding", KafkaMessageBinding);
      base.register("kafkaOperationBinding", KafkaOperationBinding);
      base.register("kafkaServerBinding", KafkaServerBinding);
      base.register("mercureChannelBinding", MercureChannelBinding);
      base.register("mercureMessageBinding", MercureMessageBinding);
      base.register("mercureOperationBinding", MercureOperationBinding);
      base.register("mercureServerBinding", MercureServerBinding);
      base.register("mqttChannelBinding", MqttChannelBinding);
      base.register("mqttMessageBinding", MqttMessageBinding);
      base.register("mqttOperationBinding", MqttOperationBinding);
      base.register("mqttServerBinding", MqttServerBinding);
      base.register("mqtt5ChannelBinding", Mqtt5ChannelBinding);
      base.register("mqtt5MessageBinding", Mqtt5MessageBinding);
      base.register("mqtt5OperationBinding", Mqtt5OperationBinding);
      base.register("mqtt5ServerBinding", Mqtt5ServerBinding);
      base.register("natsChannelBinding", NatsChannelBinding);
      base.register("natsMessageBinding", NatsMessageBinding);
      base.register("natsOperationBinding", NatsOperationBinding);
      base.register("natsServerBinding", NatsServerBinding);
      base.register("pulsarChannelBinding", PulsarChannelBinding);
      base.register("pulsarMessageBinding", PulsarMessageBinding);
      base.register("pulsarOperationBinding", PulsarOperationBinding);
      base.register("pulsarServerBinding", PulsarServerBinding);
      base.register("redisChannelBinding", RedisChannelBinding);
      base.register("redisMessageBinding", RedisMessageBinding);
      base.register("redisOperationBinding", RedisOperationBinding);
      base.register("redisServerBinding", RedisServerBinding);
      base.register("snsChannelBinding", SnsChannelBinding);
      base.register("snsMessageBinding", SnsMessageBinding);
      base.register("snsOperationBinding", SnsOperationBinding);
      base.register("snsServerBinding", SnsServerBinding);
      base.register("solaceChannelBinding", SolaceChannelBinding);
      base.register("solaceMessageBinding", SolaceMessageBinding);
      base.register("solaceOperationBinding", SolaceOperationBinding);
      base.register("solaceServerBinding", SolaceServerBinding);
      base.register("sqsChannelBinding", SqsChannelBinding);
      base.register("sqsMessageBinding", SqsMessageBinding);
      base.register("sqsOperationBinding", SqsOperationBinding);
      base.register("sqsServerBinding", SqsServerBinding);
      base.register("stompChannelBinding", StompChannelBinding);
      base.register("stompMessageBinding", StompMessageBinding);
      base.register("stompOperationBinding", StompOperationBinding);
      base.register("stompServerBinding", StompServerBinding);
      base.register("webSocketChannelBinding", WebSocketChannelBinding);
      base.register("webSocketMessageBinding", WebSocketMessageBinding);
      base.register("webSocketOperationBinding", WebSocketOperationBinding);
      base.register("webSocketServerBinding", WebSocketServerBinding);
      return base;
    }
  };
  ...
  const _ComponentsReplies = class _ComponentsReplies extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.classes.push(_ComponentsReplies.primaryClass);
    }
  };
  __publicField$6(_ComponentsReplies, "primaryClass", "components-replies");
  let ComponentsReplies = _ComponentsReplies;

  var __defProp$6 = Object.defineProperty;
  var __defNormalProp$6 = (obj, key, value) => key in obj ? __defProp$6(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
  var __publicField$5 = (obj, key, value) => __defNormalProp$6(obj, key + "" , value);
  const _ComponentsReplyAddresses = class _ComponentsReplyAddresses extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.classes.push(_ComponentsReplyAddresses.primaryClass);
    }
  };
  __publicField$5(_ComponentsReplyAddresses, "primaryClass", "components-reply-addresses");
  let ComponentsReplyAddresses = _ComponentsReplyAddresses;

  var __defProp$5 = Object.defineProperty;
  var __defNormalProp$5 = (obj, key, value) => key in obj ? __defProp$5(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
  var __publicField$4 = (obj, key, value) => __defNormalProp$5(obj, key + "" , value);
  const _ComponentsOperations = class _ComponentsOperations extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.classes.push(_ComponentsOperations.primaryClass);
    }
  };
  __publicField$4(_ComponentsOperations, "primaryClass", "components-operations");
  let ComponentsOperations = _ComponentsOperations;

  var __defProp$4 = Object.defineProperty;
  var __defNormalProp$4 = (obj, key, value) => key in obj ? __defProp$4(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
  var __publicField$3 = (obj, key, value) => __defNormalProp$4(obj, key + "" , value);
  const _ChannelServers = class _ChannelServers extends minimExports.ArrayElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.classes.push(_ChannelServers.primaryClass);
    }
  };
  __publicField$3(_ChannelServers, "primaryClass", "channel-servers");
  let ChannelServers = _ChannelServers;

  class ComponentsSchemas extends ComponentsSchemas$1 {
  }

  class MessageExamples extends MessageExamples$1 {
  }

  class MessageTraits extends MessageTraits$1 {
  }

  var __defProp$3 = Object.defineProperty;
  var __defNormalProp$3 = (obj, key, value) => key in obj ? __defProp$3(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
  var __publicField$2 = (obj, key, value) => __defNormalProp$3(obj, key + "" , value);
  const _OperationMessages = class _OperationMessages extends minimExports.ArrayElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.classes.push(_OperationMessages.primaryClass);
    }
  };
  __publicField$2(_OperationMessages, "primaryClass", "operation-messages");
  let OperationMessages = _OperationMessages;

  var __defProp$2 = Object.defineProperty;
  var __defNormalProp$2 = (obj, key, value) => key in obj ? __defProp$2(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
  var __publicField$1 = (obj, key, value) => __defNormalProp$2(obj, key + "" , value);
  const _OperationReplyMessages = class _OperationReplyMessages extends minimExports.ArrayElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.classes.push(_OperationReplyMessages.primaryClass);
    }
  };
  __publicField$1(_OperationReplyMessages, "primaryClass", "operation-reply-messages");
  let OperationReplyMessages = _OperationReplyMessages;

  class OperationSecurity extends OperationSecurity$1 {
  }

  class OperationTraits extends OperationTraits$1 {
  }

  class OperationTraitSecurity extends OperationTraitSecurity$1 {
  }

  var __defProp$1 = Object.defineProperty;
  var __defNormalProp$1 = (obj, key, value) => key in obj ? __defProp$1(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
  var __publicField = (obj, key, value) => __defNormalProp$1(obj, key + "" , value);
  const _SecuritySchemeScopes = class _SecuritySchemeScopes extends minimExports.ArrayElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.classes.push(_SecuritySchemeScopes.primaryClass);
    }
  };
  __publicField(_SecuritySchemeScopes, "primaryClass", "security-scheme-scopes");
  let SecuritySchemeScopes = _SecuritySchemeScopes;
  ...
  const schema = {
    AsyncApi3Element: {
      asyncapi(...args) {
        return new AsyncApiVersion(...args);
      },
      identifier(...args) {
      ...
      defaultContentType(...args) {
        return new DefaultContentType(...args);
      },
      channels(...args) {
        return new Channels(...args);
      },
      components(...args) {
        return new Components(...args);
      },
      operations(...args) {
        return new Operations(...args);
      }
    },
    InfoElement: {
      contact(...args) {
    ...
    ServerElement: {
      ...
      security(...args) {
        return new ServerSecurity(...args);
      },
      tags(...args) {
        return new Tags(...args);
      },
      ...
      bindings(...args) {
        return new ServerBindings(...args);
      }
    },
    ...
    ChannelElement: {
      servers(...args) {
        return new ChannelServers(...args);
      },
      parameters(...args) {
      ...
      bindings(...args) {
        return new ChannelBindings(...args);
      },
      tags(...args) {
        return new Tags(...args);
      },
    ...
    OperationElement: {
      ...
      bindings(...args) {
        return new OperationBindings(...args);
      },
      traits(...args) {
        return new OperationTraits(...args);
      },
      security(...args) {
        return new OperationSecurity(...args);
      },
      messages(...args) {
        return new OperationMessages(...args);
      },
      reply(...args) {
        return new OperationReply(...args);
      }
    },
    OperationTraitElement: {
      security(...args) {
        return new OperationTraitSecurity(...args);
      },
      tags(...args) {
        return new Tags(...args);
      },
    ...
    OperationReplyElement: {
      address(...args) {
        return new OperationReplyAddress(...args);
      },
      channel(...args) {
        return new Reference(...args);
      },
      messages(...args) {
        return new OperationReplyMessages(...args);
      }
    },
    ParametersElement: {
    ...
    ServerBindingsElement: {
      http(...args) {
        return new HttpServerBinding(...args);
      },
      ws(...args) {
        return new WebSocketServerBinding(...args);
      },
      kafka(...args) {
        return new KafkaServerBinding(...args);
      },
      anypointmq(...args) {
        return new AnypointmqServerBinding(...args);
      },
      amqp(...args) {
        return new AmqpServerBinding(...args);
      },
      amqp1(...args) {
        return new Amqp1ServerBinding(...args);
      },
      mqtt(...args) {
        return new MqttServerBinding(...args);
      },
      mqtt5(...args) {
        return new Mqtt5ServerBinding(...args);
      },
      nats(...args) {
        return new NatsServerBinding(...args);
      },
      jms(...args) {
        return new JmsServerBinding(...args);
      },
      sns(...args) {
        return new SnsServerBinding(...args);
      },
      solace(...args) {
        return new SolaceServerBinding(...args);
      },
      sqs(...args) {
        return new SqsServerBinding(...args);
      },
      stomp(...args) {
        return new StompServerBinding(...args);
      },
      redis(...args) {
        return new RedisServerBinding(...args);
      },
      mercure(...args) {
        return new MercureServerBinding(...args);
      },
      ibmmq(...args) {
        return new IbmmqServerBinding(...args);
      },
      googlepubsub(...args) {
        return new GooglepubsubServerBinding(...args);
      },
      pulsar(...args) {
        return new PulsarServerBinding(...args);
      }
    },
    ChannelBindingsElement: {
      http(...args) {
        return new HttpChannelBinding(...args);
      },
      ws(...args) {
        return new WebSocketChannelBinding(...args);
      },
      kafka(...args) {
        return new KafkaChannelBinding(...args);
      },
      anypointmq(...args) {
        return new AnypointmqChannelBinding(...args);
      },
      amqp(...args) {
        return new AmqpChannelBinding(...args);
      },
      amqp1(...args) {
        return new Amqp1ChannelBinding(...args);
      },
      mqtt(...args) {
        return new MqttChannelBinding(...args);
      },
      mqtt5(...args) {
        return new Mqtt5ChannelBinding(...args);
      },
      nats(...args) {
        return new NatsChannelBinding(...args);
      },
      jms(...args) {
        return new JmsChannelBinding(...args);
      },
      sns(...args) {
        return new SnsChannelBinding(...args);
      },
      solace(...args) {
        return new SolaceChannelBinding(...args);
      },
      sqs(...args) {
        return new SqsChannelBinding(...args);
      },
      stomp(...args) {
        return new StompChannelBinding(...args);
      },
      redis(...args) {
        return new RedisChannelBinding(...args);
      },
      mercure(...args) {
        return new MercureChannelBinding(...args);
      },
      ibmmq(...args) {
        return new IbmmqChannelBinding(...args);
      },
      googlepubsub(...args) {
        return new GooglepubsubChannelBinding(...args);
      },
      pulsar(...args) {
        return new PulsarChannelBinding(...args);
      }
    },
    OperationBindingsElement: {
      http(...args) {
        return new HttpOperationBinding(...args);
      },
      ws(...args) {
        return new WebSocketOperationBinding(...args);
      },
      kafka(...args) {
        return new KafkaOperationBinding(...args);
      },
      anypointmq(...args) {
        return new AnypointmqOperationBinding(...args);
      },
      amqp(...args) {
        return new AmqpOperationBinding(...args);
      },
      amqp1(...args) {
        return new Amqp1OperationBinding(...args);
      },
      mqtt(...args) {
        return new MqttOperationBinding(...args);
      },
      mqtt5(...args) {
        return new Mqtt5OperationBinding(...args);
      },
      nats(...args) {
        return new NatsOperationBinding(...args);
      },
      jms(...args) {
        return new JmsOperationBinding(...args);
      },
      sns(...args) {
        return new SnsOperationBinding(...args);
      },
      solace(...args) {
        return new SolaceOperationBinding(...args);
      },
      sqs(...args) {
        return new SqsOperationBinding(...args);
      },
      stomp(...args) {
        return new StompOperationBinding(...args);
      },
      redis(...args) {
        return new RedisOperationBinding(...args);
      },
      mercure(...args) {
        return new MercureOperationBinding(...args);
      },
      googlepubsub(...args) {
        return new GooglepubsubOperationBinding(...args);
      },
      ibmmq(...args) {
        return new IbmmqOperationBinding(...args);
      },
      pulsar(...args) {
        return new PulsarOperationBinding(...args);
      }
    },
    MessageBindingsElement: {
      http(...args) {
        return new HttpMessageBinding(...args);
      },
      ws(...args) {
        return new WebSocketMessageBinding(...args);
      },
      kafka(...args) {
        return new KafkaMessageBinding(...args);
      },
      anypointmq(...args) {
        return new AnypointmqMessageBinding(...args);
      },
      amqp(...args) {
        return new AmqpMessageBinding(...args);
      },
      amqp1(...args) {
        return new Amqp1MessageBinding(...args);
      },
      mqtt(...args) {
        return new MqttMessageBinding(...args);
      },
      mqtt5(...args) {
        return new Mqtt5MessageBinding(...args);
      },
      nats(...args) {
        return new NatsMessageBinding(...args);
      },
      jms(...args) {
        return new JmsMessageBinding(...args);
      },
      sns(...args) {
        return new SnsMessageBinding(...args);
      },
      solace(...args) {
        return new SolaceMessageBinding(...args);
      },
      sqs(...args) {
        return new SqsMessageBinding(...args);
      },
      stomp(...args) {
        return new StompMessageBinding(...args);
      },
      redis(...args) {
        return new RedisMessageBinding(...args);
      },
      mercure(...args) {
        return new MercureMessageBinding(...args);
      },
      ibmmq(...args) {
        return new IbmmqMessageBinding(...args);
      },
      googlepubsub(...args) {
        return new GooglepubsubMessageBinding(...args);
      },
      pulsar(...args) {
        return new PulsarMessageBinding(...args);
      }
    },
    MessageElement: {
      headers(...args) {
      ...
      bindings(...args) {
        return new MessageBindings(...args);
      },
      examples(...args) {
        return new MessageExamples(...args);
      },
      traits(...args) {
        return new MessageTraits(...args);
      },
      payload(...args) {
        return new Schema(...args);
      }
    ...
    MessageExampleElement: {
      headers(...args) {
        return new minimExports.ObjectElement(...args);
      }
    },
    TagsElement: {
    ...
    ComponentsElement: {
      ...
      servers(...args) {
        return new ComponentsServers(...args);
      },
      serverVariables(...args) {
        return new ComponentsServerVariables(...args);
      },
      messages(...args) {
        return new ComponentsMessages(...args);
      },
      ...
      correlationIds(...args) {
        return new ComponentsCorrelationIDs(...args);
      },
      operationTraits(...args) {
        return new ComponentsOperationTraits(...args);
      },
      messageTraits(...args) {
        return new ComponentsMessageTraits(...args);
      },
      serverBindings(...args) {
        return new ComponentsServerBindings(...args);
      },
      channelBindings(...args) {
        return new ComponentsChannelBindings(...args);
      },
      operationBindings(...args) {
        return new ComponentsOperationBindings(...args);
      },
      messageBindings(...args) {
        return new ComponentsMessageBindings(...args);
      },
      operations(...args) {
        return new ComponentsOperations(...args);
      },
      replies(...args) {
        return new OperationReply(...args);
      },
    ...
    MultiFormatSchemaElement: {
      schema(...args) {
        const { context: multiFormatSchemaElement } = this;
        const schemaFormat = defaultTo(
          mediaTypes$1.latest(),
          serializer(multiFormatSchemaElement.schemaFormat)
        );
        if (mediaTypes$1.includes(schemaFormat)) {
          return new Schema(...args);
        }
        return new minimExports.ObjectElement(...args);
      }
    ...
    OAuthFlowElement: {
      availableScopes(...args) {
        return new SecuritySchemeScopes(...args);
      }
    },
    ...
    [ComponentsServers.primaryClass]: {
      "[key: *]": function key7(...args) {
        return new Server(...args);
      }
    },
    [ComponentsServerVariables.primaryClass]: {
      "[key: *]": function key8(...args) {
        return new ServerVariable(...args);
      }
    },
    [ComponentsMessages.primaryClass]: {
    ...
    [ComponentsCorrelationIDs.primaryClass]: {
      "[key: *]": function key12(...args) {
        return new CorrelationID(...args);
      }
    },
    [ComponentsOperationTraits.primaryClass]: {
      "[key: *]": function key13(...args) {
        return new OperationTrait(...args);
      }
    },
    [ComponentsMessageTraits.primaryClass]: {
      "[key: *]": function key14(...args) {
        return new MessageTrait(...args);
      }
    },
    [ComponentsServerBindings.primaryClass]: {
      "[key: *]": function key15(...args) {
        return new ServerBindings(...args);
      }
    },
    [ComponentsChannelBindings.primaryClass]: {
      "[key: *]": function key16(...args) {
        return new ChannelBindings(...args);
      }
    },
    [ComponentsOperationBindings.primaryClass]: {
      "[key: *]": function key17(...args) {
        return new OperationBindings(...args);
      }
    },
    [ComponentsOperations.primaryClass]: {
      "[key: *]": function key18(...args) {
        return new OperationBindings(...args);
      }
    },
    [ComponentsMessageBindings.primaryClass]: {
    ...
    [ServerSecurity.primaryClass]: {
      "<*>": function asterisk3(...args) {
        return new SecurityScheme(...args);
      }
    },
    [OperationTraits.primaryClass]: {
    ...
    [OperationMessages.primaryClass]: {
      "<*>": function asterisk6(...args) {
        return new Reference(...args);
      }
    },
    [OperationReplyMessages.primaryClass]: {
      "<*>": function asterisk7(...args) {
        return new Reference(...args);
      }
    },
    [MessageExamples.primaryClass]: {
      "<*>": function asterisk8(...args) {
        return new MessageExample(...args);
      }
    },
    [MessageTraits.primaryClass]: {
      "<*>": function asterisk9(...args) {
        return new MessageTrait(...args);
      }
    },
    [MessageTraitExamples.primaryClass]: {
      "<*>": function asterisk10(...args) {
        return new MessageExample(...args);
      }
    },
    [ChannelServers.primaryClass]: {
      "<*>": function asterisk11(...args) {
        return new Reference(...args);
      }
    },
    [ComponentsReplies.primaryClass]: {
      "[key: *]": function key21(...args) {
        return new OperationReply(...args);
      }
    },
    [ComponentsReplyAddresses.primaryClass]: {
  ...
  const findElementFactory = (ancestor, keyName) => {
    ...
    const keyMapping = schema[elementType != null ? elementType : ""] || schema[serializer(ancestor.classes.first)];
  ...
  const plugin = () => () => ({
    visitor: {
      StringElement(element, key24, parent, path, ancestors) {
  ...
  const isAsyncApi3Element = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq, hasClass }) => {
      return (element) => element instanceof AsyncApi3 || hasBasicElementProps(element) && isElementType("asyncApi3", element) && primitiveEq("object", element) && hasClass("api", element);
    }
  );
  const isAsyncApiVersionElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof AsyncApiVersion || hasBasicElementProps(element) && isElementType("asyncApiVersion", element) && primitiveEq("string", element);
    }
  );
  const isChannelBindingsElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof ChannelBindings || hasBasicElementProps(element) && isElementType("channelBindings", element) && primitiveEq("object", element);
    }
  );
  const isChannelElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof Channel || hasBasicElementProps(element) && isElementType("channel", element) && primitiveEq("object", element);
    }
  );
  const isChannelsElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof Channels || hasBasicElementProps(element) && isElementType("channels", element) && primitiveEq("object", element);
    }
  );
  ...
  const isIdentifierElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof Identifier || hasBasicElementProps(element) && isElementType("identifier", element) && primitiveEq("string", element);
    }
  );
  ...
  const isParametersElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof Parameters || hasBasicElementProps(element) && isElementType("parameters", element) && primitiveEq("object", element);
    }
  );
  ...
  const isServerBindingsElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof ServerBindings || hasBasicElementProps(element) && isElementType("serverBindings", element) && primitiveEq("object", element);
    }
  );
  const isServersElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof Servers || hasBasicElementProps(element) && isElementType("servers", element) && primitiveEq("object", element);
    }
  );
  ...
  const isMultiFormatSchemaElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof MultiFormatSchema || hasBasicElementProps(element) && isElementType("multiFormatSchema", element) && primitiveEq("object", element);
    }
  );

  exports.Amqp1ChannelBindingElement = Amqp1ChannelBinding;
  exports.Amqp1MessageBindingElement = Amqp1MessageBinding;
  exports.Amqp1OperationBindingElement = Amqp1OperationBinding;
  exports.Amqp1ServerBindingElement = Amqp1ServerBinding;
  exports.AmqpChannelBindingElement = AmqpChannelBinding;
  exports.AmqpMessageBindingElement = AmqpMessageBinding;
  exports.AmqpOperationBindingElement = AmqpOperationBinding;
  exports.AmqpServerBindingElement = AmqpServerBinding;
  exports.AnypointmqChannelBindingElement = AnypointmqChannelBinding;
  exports.AnypointmqMessageBindingElement = AnypointmqMessageBinding;
  exports.AnypointmqOperationBindingElement = AnypointmqOperationBinding;
  exports.AnypointmqServerBindingElement = AnypointmqServerBinding;
  exports.AsyncAPIMediaTypes = AsyncAPIMediaTypes$1;
  exports.AsyncApi3Element = AsyncApi3;
  exports.AsyncApiVersionElement = AsyncApiVersion;
  exports.ChannelBindingsElement = ChannelBindings;
  exports.ChannelElement = Channel;
  exports.ChannelsElement = Channels;
  exports.ComponentsElement = Components;
  exports.ContactElement = Contact;
  exports.CorrelationIDElement = CorrelationID;
  exports.DefaultContentTypeElement = DefaultContentType;
  exports.ExternalDocumentationElement = ExternalDocumentation;
  exports.GooglepubsubChannelBindingElement = GooglepubsubChannelBinding;
  exports.GooglepubsubMessageBindingElement = GooglepubsubMessageBinding;
  exports.GooglepubsubOperationBindingElement = GooglepubsubOperationBinding;
  exports.GooglepubsubServerBindingElement = GooglepubsubServerBinding;
  exports.HttpChannelBindingElement = HttpChannelBinding;
  exports.HttpMessageBindingElement = HttpMessageBinding;
  exports.HttpOperationBindingElement = HttpOperationBinding;
  exports.HttpServerBindingElement = HttpServerBinding;
  exports.IbmmqChannelBindingElement = IbmmqChannelBinding;
  exports.IbmmqMessageBindingElement = IbmmqMessageBinding;
  exports.IbmmqOperationBindingElement = IbmmqOperationBinding;
  exports.IbmmqServerBindingElement = IbmmqServerBinding;
  exports.IdentifierElement = Identifier;
  exports.InfoElement = Info;
  exports.JmsChannelBindingElement = JmsChannelBinding;
  exports.JmsMessageBindingElement = JmsMessageBinding;
  exports.JmsOperationBindingElement = JmsOperationBinding;
  exports.JmsServerBindingElement = JmsServerBinding;
  exports.KafkaChannelBindingElement = KafkaChannelBinding;
  exports.KafkaMessageBindingElement = KafkaMessageBinding;
  exports.KafkaOperationBindingElement = KafkaOperationBinding;
  exports.KafkaServerBindingElement = KafkaServerBinding;
  exports.LicenseElement = License;
  exports.MercureChannelBindingElement = MercureChannelBinding;
  exports.MercureMessageBindingElement = MercureMessageBinding;
  exports.MercureOperationBindingElement = MercureOperationBinding;
  exports.MercureServerBindingElement = MercureServerBinding;
  exports.MessageBindingsElement = MessageBindings;
  exports.MessageElement = Message;
  exports.MessageExampleElement = MessageExample;
  exports.MessageTraitElement = MessageTrait;
  exports.MessagesElement = Messages;
  exports.Mqtt5ChannelBindingElement = Mqtt5ChannelBinding;
  exports.Mqtt5MessageBindingElement = Mqtt5MessageBinding;
  exports.Mqtt5OperationBindingElement = Mqtt5OperationBinding;
  exports.Mqtt5ServerBindingElement = Mqtt5ServerBinding;
  exports.MqttChannelBindingElement = MqttChannelBinding;
  exports.MqttMessageBindingElement = MqttMessageBinding;
  exports.MqttOperationBindingElement = MqttOperationBinding;
  exports.MqttServerBindingElement = MqttServerBinding;
  exports.MultiFormatSchemaElement = MultiFormatSchema;
  exports.NatsChannelBindingElement = NatsChannelBinding;
  exports.NatsMessageBindingElement = NatsMessageBinding;
  exports.NatsOperationBindingElement = NatsOperationBinding;
  exports.NatsServerBindingElement = NatsServerBinding;
  exports.OAuthFlowElement = OAuthFlow;
  exports.OAuthFlowsElement = OAuthFlows;
  exports.OperationBindingsElement = OperationBindings;
  exports.OperationElement = Operation;
  exports.OperationReplyAddressElement = OperationReplyAddress;
  exports.OperationReplyElement = OperationReply;
  exports.OperationTraitElement = OperationTrait;
  exports.OperationsElement = Operations;
  exports.ParameterElement = Parameter;
  exports.ParametersElement = Parameters;
  exports.PulsarChannelBindingElement = PulsarChannelBinding;
  exports.PulsarMessageBindingElement = PulsarMessageBinding;
  exports.PulsarOperationBindingElement = PulsarOperationBinding;
  exports.PulsarServerBindingElement = PulsarServerBinding;
  exports.RedisChannelBindingElement = RedisChannelBinding;
  exports.RedisMessageBindingElement = RedisMessageBinding;
  exports.RedisOperationBindingElement = RedisOperationBinding;
  exports.RedisServerBindingElement = RedisServerBinding;
  exports.ReferenceElement = Reference;
  exports.SchemaElement = Schema;
  exports.SecuritySchemeElement = SecurityScheme;
  exports.ServerBindingsElement = ServerBindings;
  exports.ServerElement = Server;
  exports.ServerVariableElement = ServerVariable;
  exports.ServersElement = Servers;
  exports.SnsChannelBindingElement = SnsChannelBinding;
  exports.SnsMessageBindingElement = SnsMessageBinding;
  exports.SnsOperationBindingElement = SnsOperationBinding;
  exports.SnsServerBindingElement = SnsServerBinding;
  exports.SolaceChannelBindingElement = SolaceChannelBinding;
  exports.SolaceMessageBindingElement = SolaceMessageBinding;
  exports.SolaceOperationBindingElement = SolaceOperationBinding;
  exports.SolaceServerBindingElement = SolaceServerBinding;
  exports.SqsChannelBindingElement = SqsChannelBinding;
  exports.SqsMessageBindingElement = SqsMessageBinding;
  exports.SqsOperationBindingElement = SqsOperationBinding;
  exports.SqsServerBindingElement = SqsServerBinding;
  exports.StompChannelBindingElement = StompChannelBinding;
  exports.StompMessageBindingElement = StompMessageBinding;
  exports.StompOperationBindingElement = StompOperationBinding;
  exports.StompServerBindingElement = StompServerBinding;
  exports.TagElement = Tag;
  exports.TagsElement = Tags;
  exports.WebSocketChannelBindingElement = WebSocketChannelBinding;
  exports.WebSocketMessageBindingElement = WebSocketMessageBinding;
  exports.WebSocketOperationBindingElement = WebSocketOperationBinding;
  exports.WebSocketServerBindingElement = WebSocketServerBinding;
  exports.default = asyncApi3;
  exports.getNodeType = getNodeType;
  exports.isAsyncApi3Element = isAsyncApi3Element;
  exports.isAsyncApiVersionElement = isAsyncApiVersionElement;
  exports.isChannelBindingsElement = isChannelBindingsElement;
  exports.isChannelElement = isChannelElement;
  ...
  exports.isMultiFormatSchemaElement = isMultiFormatSchemaElement;
  ...
  exports.mediaTypes = mediaTypes$1;
  exports.refractorPluginReplaceEmptyElement = plugin;
