(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomParserAdapterAsyncapiJson2 = {}, global.fs, global.path));
   ...
   * @public
   */
  const isNode$3 = node => typeof getNodeType$4(node) === 'string';
  ...
  // isNode :: Node -> Boolean
  const isNode$2 = pipe(getNodeType$3, isString$1);
  ...
  ParseResult$1.refract = createRefractor$3(ParseResult$1);
  ...
  const serializer = element => {
    ...
    return visit(element, new Visitor$1());
  };
   ...
   * @public
   */
  let JSONSchemaVisitor$2 = class JSONSchemaVisitor extends Mixin(FixedFieldsVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
   ...
   * @public
   */
  let ItemsVisitor$1 = class ItemsVisitor extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    ObjectElement(objectElement) {
   ...
   * @public
   */
  let LinkDescriptionVisitor$2 = class LinkDescriptionVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
   ...
   * @public
   */
  class ItemsVisitor extends ItemsVisitor$1 {
    BooleanElement(booleanElement) {
  ...
  const detectionRegExp = new RegExp('"asyncapi"\\s*:\\s*"(?<version_json>2\\.(?:[1-9]\\d*|0)\\.(?:[1-9]\\d*|0))"');
  ...
  const parse = (_0, ..._1) => __async(null, [_0, ..._1], function* (source, options = {}) {
    ...
    if (isNotUndefined(result)) {
      const asyncApiElement = AsyncApi2.refract(result, refractorOpts);
