(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomParserAdapterOpenapiYaml2 = {}, global.fs, global.path));
  ...
  const createRefractor$1 = Type => (value, options = {}) => refract$1(value, {
    ...options,
    Type
  });

  minimExports.ObjectElement.refract = createRefractor$1(minimExports.ObjectElement);
  minimExports.ArrayElement.refract = createRefractor$1(minimExports.ArrayElement);
  minimExports.StringElement.refract = createRefractor$1(minimExports.StringElement);
  minimExports.BooleanElement.refract = createRefractor$1(minimExports.BooleanElement);
  minimExports.NullElement.refract = createRefractor$1(minimExports.NullElement);
  minimExports.NumberElement.refract = createRefractor$1(minimExports.NumberElement);
  minimExports.LinkElement.refract = createRefractor$1(minimExports.LinkElement);
  minimExports.RefElement.refract = createRefractor$1(minimExports.RefElement);
  Annotation.refract = createRefractor$1(Annotation);
  Comment.refract = createRefractor$1(Comment);
  ParseResult$1.refract = createRefractor$1(ParseResult$1);
   ...
   * @public
   */
  class JSONSchema extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  class LinkDescription extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  const jsonSchemaDraft4 = {
    namespace: options => {
      ...
      base.register('jSONSchemaDraft4', JSONSchema);
  ...
  const isJSONSchemaElement = createPredicate(({
    ...
    return element => element instanceof JSONSchema || hasBasicElementProps(element) && isElementType('JSONSchemaDraft4', element) && primitiveEq('object', element);
  });
  ...
  JSONReference.refract = createRefractor(['visitors', 'document', 'objects', 'JSONReference', '$visitor']);
  Media.refract = createRefractor(['visitors', 'document', 'objects', 'Media', '$visitor']);
   ...
   * @public
   */
  class Swagger extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class SwaggerVersion extends minimExports.StringElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Paths extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'paths';
    }
   ...
   * @public
   */
  class Parameter extends JSONSchema {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Items extends JSONSchema {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'items';
      this.classes.push('json-schema-draft-4');
   ...
   * @public
   */
  class Example extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Responses extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Response extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Headers extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Header extends JSONSchema {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'header';
      this.classes.push('json-schema-draft-4');
   ...
   * @public
   */
  class Xml extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'xml';
    }
   ...
   * @public
   */
  class Definitions extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class ParametersDefinitions extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
   ...
   * @public
   */
  class Scopes extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
      this.element = 'scopes';
    }
  ...
  const openApi2 = {
    namespace: options => {
      ...
      base.register('swagger', Swagger);
      base.register('swaggerVersion', SwaggerVersion);
      ...
      base.register('definitions', Definitions);
      base.register('parametersDefinitions', ParametersDefinitions);
      base.register('responsesDefinitions', ResponsesDefinitions);
      base.register('securityDefinitions', SecurityDefinitions);
      base.register('securityScheme', SecurityScheme);
      base.register('scopes', Scopes);
  ...
  const detectionRegExp = new RegExp(`(?<YAML>^(["']?)swagger\\2\\s*:\\s*(["'])(?<version_yaml>2\\.0)\\3(?:\\s+|$))|(?<JSON>"swagger"\\s*:\\s*"(?<version_json>2\\.0)")`, "m");
  ...
  const parse = (_0, ..._1) => __async(null, [_0, ..._1], function* (source, options = {}) {
    ...
    if (isNotUndefined(result)) {
      const swaggerElement = Swagger.refract(result, refractorOpts);
      swaggerElement.classes.push("result");
      parseResultElement.replaceResult(swaggerElement);
    }
    return parseResultElement;
  });
  const namespace = createNamespace(openApi2);
